...
public class TushuEntity<T> implements Serializable {
    ...
    public static class Builder {
        private TushuEntity tushuEntity;

        public Builder() {
            tushuEntity = new TushuEntity();
        }
        ...
        public Builder tushuName(String tushuName) {
            tushuEntity.setTushuName(tushuName);
            return this;
        }

        // 添加其他字段的 builder 方法...

        public Builder tushuDelete(Integer tushuDelete) {
            tushuEntity.setTushuDelete(tushuDelete);
            return this;
        }

        public TushuEntity build() {
            return tushuEntity;
        }
    }
