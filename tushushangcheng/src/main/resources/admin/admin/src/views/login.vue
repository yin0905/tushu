<template>
    <div>
        <div class="container loginIn" style="backgroundImage: url(../../../../img/img/_back-img-bg.jpg)">
            ...
            <div :class="2 == 1 ? 'left' : 2 == 2 ? 'left center' : 'left right'" style="backgroundColor: rgba(255, 255, 255, 1)">
                <el-form class="login-form" label-position="left" :label-width="3 == 3 ? '56px' : '0px'">
                    <div class="title-container"><h3 class="title" style="color: rgba(101, 126, 253, 1)">在线图书销售平台</h3></div>
            ...
            <div style="color:rgba(101, 126, 253, 1)" class="register" @click="register('yonghu')">用户注册</div>
                      <div style="color:rgba(101, 126, 253, 1);right:0px" class="index" @click="window.parent.location.href = 'http://localhost:8080/tushushangcheng/front/index.html'">去主页</div>
                    </el-form-item>
                </el-form>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                ...
                if(this.rulesForm.role.equals("用户"))
                {
                  this.$router.push({path:'http://localhost:8080/tushushangcheng/front/index.html'})
                }
                else{
                  this.$http({
