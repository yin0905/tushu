...
!(function (c) {
    ...
    var e,
      ...
      u = function (n) {
        return n.filter(function (n) {
          return -1 === nn.inArray(o, n);
        });
      },
      c = t ? (0 < (e = u((e = i))).length ? e.concat(o) : o) : u(i);
    return 0 < c.length ? ((r = c), nn.trim(r.sort().join(" "))) : "";
  }
  function U(n, t) {
    return (
      (t = t || n.selection.getNode()),
      tn(t) ? n.dom.select("a[href]", t)[0] : n.dom.getParent(t, "a[href]")
    );
  }
  function M(n) {
  ...
  function q(n, t) {
    ...
    if (!(0 < v(n).length) && !1 === k(n)) {
      var r = D(e.rel, "_blank" === e.target);
      e.rel = r || null;
    }
    return (
      X.from(e.target).isNone() && !1 === g(n) && (e.target = p(n)),
      (e.href = (function (n, t) {
  ...
  function B(t) {
    return (
      void 0 === t && (t = K),
      function (n) {
        return X.from(n).map(function (n) {
          return (function (n, r) {
            var o = [];
            return (
              nn.each(n, function (n) {
    ...
    return o !== undefined
      ? (function (t, n) {
          return L(n, function (n) {
            return X.some(n).filter(function (n) {
              return n.value === t;
            });
          });
        })(o, e).map(function (n) {
  ...
  var W,
    ...
    X = {
      ...
      none: t,
      from: function (n) {
        return null === n || n === undefined ? C : J(n);
      },
    },
          ...
          return "url" === t.name
            ? (function (n) {
                if (o.get().length <= 0) {
                  ...
                  return X.some({ text: t, title: e });
                }
                return X.none();
              })(n())
            : I(["anchor", "link"], t.name)
              ? e(n(), t)
              : ("text" === t.name && o.set(n().text), X.none());
        },
      };
    },
    vn = {},
  ...
  (W = undefined),
    ...
    (function (n) {
      ...
      return (function l(i, u, c) {
        ...
        for (var f = "function" == typeof G && G, n = 0; n < c.length; n++)
          a(c[n]);
        return a;
      })(
        {
  ...
  function xn(n, t, e) {
    ...
    return null !== r && 0 < r.length ? X.some(r) : X.none();
  }
  function bn(n, t) {
  ...
  var On = yn.exports.boltExport,
    ...
    jn = function (n) {
      ...
      return 0 < e.length
        ? X.some([{ text: "None", value: "" }].concat(e))
        : X.none();
    },
    Fn = function (n) {
      var t = y(n);
      return 0 < t.length ? hn.sanitize(t) : X.none();
    },
    ...
    Rn = function (t) {
      ...
      return Nn(function (t) {
        ...
        return n.bind(hn.sanitizeWith(e)).map(function (n) {
    ...
    Dn = function (n, t) {
      ...
      if (0 < e.length) {
        ...
        return (
          !1 === k(n)
            ? hn.sanitizeWith(function (n) {
                return dn(hn.getValue(n), r);
              })
            : hn.sanitize
        )(e);
      }
    ...
    Mn = function (n) {
      var t = g(n);
      return f(t)
        ? hn.sanitize(t).orThunk(function () {
            return X.some(Un);
          })
        : !1 === t
          ? X.none()
    ...
    zn = function (e, r) {
      return Rn(e).map(function (n) {
        var t = (function (n, t) {
          var e = n.dom,
            r = fn(n.selection.getContent())
              ? X.some(sn(n.selection, t))
              : X.none(),
            o = t ? X.some(e.getAttrib(t, "href")) : X.none(),
            i = t ? X.from(e.getAttrib(t, "target")) : X.none(),
            u = xn(e, t, "rel"),
            c = xn(e, t, "class");
          return {
            url: o,
        ...
        .map(function (n) {
          return (function (n, t, e) {
              ...
              body: {
                ...
                items: j([
                  ...
                  (function (n) {
                    ...
                    c.anchor.map(hn.createUi("anchor", "Anchors")),
                    c.rels.map(hn.createUi("rel", "Rel")),
                    c.targets.map(hn.createUi("target", "Open link in...")),
                    c.link.map(hn.createUi("link", "Link list")),
                    c.classes.map(hn.createUi("linkClass", "Class")),
                  ]),
                ]),
              },
              buttons: [
            ...
            (function (i, u) {
              return function (n) {
                var e = n.getData();
                if (!e.url.value) return un(i), void n.close();
                function t(t) {
                  return X.from(e[t]).filter(function (n) {
    ...
    Wn = function (e) {
      return function (t) {
        function n(n) {
          return t.setActive(!e.readonly && !!ln(e, n.element));
        }
        return (
          e.on("NodeChange", n),
          function () {
    ...
    Hn = function (e) {
      return function (t) {
        t.setDisabled(!cn(e.dom.getParents(e.selection.getStart())));
        function n(n) {
          return t.setDisabled(!cn(n.parents));
        }
        return (
          e.on("NodeChange", n),
          function () {
    ...
    Qn = function (t) {
      t.ui.registry.addContextMenu("link", {
        update: function (n) {
          return cn(t.dom.getParents(n, "a")) ? "link unlink openlink" : "link";
        },
      });
    },
    Yn = function (i) {
      function n(n) {
        ...
        return n.setDisabled(!ln(i, t)), function () {};
      }
        ...
        commands: [
          {
            ...
            onSetup: function (n) {
              var t = i.selection.getNode();
              return n.setActive(!!ln(i, t)), Wn(i)(n);
            },
            onAction: function (n) {
              var t = ln(i),
                e = n.getValue();
              if (t)
                ...
                var r = { href: e, attach: function () {} },
                  o = fn(i.selection.getContent())
                    ? X.some(sn(i.selection, t))
                        .filter(function (n) {
                          return 0 < n.length;
                        })
                        .or(X.from(e))
