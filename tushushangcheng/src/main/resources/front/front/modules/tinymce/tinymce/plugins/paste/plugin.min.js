...
!(function (f) {
  ...
  var H = A.exports.boltExport,
    ...
    it = tinymce.util.Tools.resolve("tinymce.html.Serializer"),
    ut = tinymce.util.Tools.resolve("tinymce.html.Node"),
    at = tinymce.util.Tools.resolve("tinymce.html.Schema"),
    st = {
  ...
  function ht(t, e) {
    return (
      t.insertContent(e, { merge: st.shouldMergeFormats(t), paste: !0 }), !0
    );
  }
  function vt(t) {
  ...
  function It(a, s, i) {
    ...
    function l(t, e, n, r) {
      ...
      kt(t, "text/html")
        ...
        (o.length && (!i || u)) || (n = !0),
        (n || u) &&
          (o = kt(t, "text/plain") && i ? t["text/plain"] : lt.innerText(o)),
      ...
      a.on("paste", function (t) {
        ...
        (u = !1),
          ...
          (function (t) {
            ...
            ? s.remove()
            : Ft(n) || !St(a, t, s.getLastRng() || a.selection.getRng())
              ? (e || t.preventDefault(),
                !V.ie ||
                  (e && !t.ieFake) ||
                  kt(n, "text/html") ||
  ...
  var zt = {
        ...
        return st.shouldUseDefaultFilters(t)
          ? (function (r, t) {
              ...
              var n = st.getWordValidElements(r),
                i = at({ valid_elements: n, valid_children: "-li[p]" });
              ...
              return (
                ...
                (t = it({ validate: r.settings.validate }, i).serialize(a))
              );
            })(t, e)
          : e;
      },
    ...
    Gt = lt.createIdGenerator("mceclip"),
    Xt = function (t) {
    ...
    Jt = tinymce.util.Tools.resolve("tinymce.dom.RangeUtils"),
    Qt = function (i, u, a) {
