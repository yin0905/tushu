...
!(function (t) {
  ...
  function r(c, r) {
    ...
    return (
      ...
      (p = r.schema.getShortEndedElements()),
      {
        ...
        matchFromElement: function k(e) {
          return i[e.getAttribute("data-mce-index")];
        },
        elementFromMatch: function N(e) {
          return s(l(e))[0];
        },
        find: function y(e, t) {
          ...
          return (
            i.length &&
              (function f(e, t, n) {
                ...
                e: for (;;) {
                  if (
                    ((g[l.nodeName] || p[l.nodeName] || T(l)) && s++,
                    3 === l.nodeType &&
                      (!o && l.length + s >= a.end
                        ? ((o = l), (c = a.end - s))
                        : r && u.push(l),
                ...
                (function t(o) {
                  ...
                  return function (e) {
                    ...
                    for (
                      var l = m(o.data.substring(e.startNodeIndex), c),
                        d = 0,
                    ...
                    var p = m(i.data.substring(0, e.endNodeIndex), c);
                    return (
  ...
  function B(e, t, n, r, o, i, c) {
    var a = p(e);
    (
      a ||
      (function (c, a, u) {
        return function (e, t, r, o) {
          var n = { method: e, lang: u.get() },
            i = "";
  ...
  function A(e, t, n) {
    e.dom.select("span.mce-spellchecker-word").length || C(e, t, n);
  }
  function E(e) {
  ...
  var P = Object.hasOwnProperty,
    C = function (e, t, n) {
      ...
      if (
        (I(e, n).reset(), e.selection.moveToBookmark(r), n.set(null), t.get())
      )
    ...
    O = function (t, e, n, r, o) {
      ...
      r.set({ suggestions: c, hasDictionarySupport: i });
      var u = t.selection.getBookmark();
      I(t, n)
        .find(m(t))
        .filter(function (e) {
          return !!c[e.text];
      ...
      addToDictionary: function (t, e, n, r, o, i, c) {
        t.setProgressState(!0),
          B(
            ...
            i,
            function () {
              t.setProgressState(!1), t.dom.remove(c, !0), A(t, n, r);
            },
            function (e) {
              t.notificationManager.open({ text: e, type: "error" }),
                t.setProgressState(!1);
    ...
    j = function (n, e, r, t, o, i) {
      function c() {
        _.spellcheck(n, e, r, t, i, o);
      }
      var a = (function (e, t) {
          var n = [];
          return (
      ...
      1 < a.length
        ? n.ui.registry.addSplitButton("spellchecker", s)
        : n.ui.registry.addToggleButton("spellchecker", u),
                ...
                return (
                  ...
                  n.get().hasDictionarySupport &&
                    ...
                    u.push({
                      ...
                      onAction: function () {
                        _.addToDictionary(t, e, r, o, i, c, a);
                      },
                    })),
                  u.push.apply(u, [
                    { type: "separator" },
                    {
                      text: "Ignore",
                      onAction: function () {
                        _.ignoreWord(t, r, o, c, a);
                      },
                    },
                    {
                      text: "Ignore all",
                      onAction: function () {
                        _.ignoreWord(t, r, o, c, a, !0);
                      },
                    },
                  ]),
                  u
                );
              })(o, i, c, a, u, s, t.getAttribute("data-mce-word"), n)
            );
          }
        },
      });
