...
!(function () {
  ...
  var r,
    ...
    a = tinymce.util.Tools.resolve("tinymce.util.XHR"),
    m = function (e) {
    ...
    x = function (t, e, n) {
      ...
      (n = i(n, h(t))),
        ...
        p.each(o.select("*", r), function (e) {
          s(e, m(t).replace(/\s+/g, "|")) && (e.innerHTML = M(t, b(t))),
            s(e, d(t).replace(/\s+/g, "|")) && (e.innerHTML = M(t, O(t))),
  ...
  var k,
    ...
    L = {
      ...
      none: n,
      from: function (e) {
        return null === e || e === undefined ? A : J(e);
      },
    },
    Y =
      ((k = "function"),
      ...
      (function () {
        ...
        function u(e, t) {
          return {
            ...
            onSubmit: (function (n) {
              return function (t) {
                var e = t.getData();
                o(n, e.template).each(function (e) {
                  s(e)
                    .then(function (e) {
                      x(i, !1, e), t.close();
                    })
        ...
        var c = e(n),
          r = function (e, t, n) {
            ...
            e.unblock(), e.redial(u(a, o)), e.focus("template");
          },
