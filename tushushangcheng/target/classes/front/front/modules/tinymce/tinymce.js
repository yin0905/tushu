...
layui.define(["jquery"], function (exports) {
  ...
  t.render = function (option, callback) {
    ...
    option.quickbars_selection_toolbar = option.quickbars_selection_toolbar
      ? option.quickbars_selection_toolbar
      : "cut copy | bold italic underline strikethrough ";

    option.plugins = option.plugins
      ? option.plugins
      : "quickbars print preview searchreplace autolink fullscreen image link media codesample table charmap hr advlist lists wordcount imagetools indent2em";

    option.toolbar = option.toolbar
      ? option.toolbar
      : "undo redo | forecolor backcolor bold italic underline strikethrough | indent2em alignleft aligncenter alignright alignjustify outdent indent | link bullist numlist image table codesample | formatselect fontselect fontsizeselect";
    ...
    option.menubar = option.menubar
      ? option.menubar
      : "file edit insert format table";

    option.images_upload_url = option.images_upload_url
      ? option.images_upload_url
      : settings.images_upload_url;

    option.images_upload_handler = option.images_upload_handler
    ...
    option.menu = option.menu
      ...
      : {
          ...
          format: {
            title: "格式",
            items:
              "bold italic underline strikethrough superscript subscript | formats | forecolor backcolor | removeformat",
          },
          table: {
            title: "表格",
