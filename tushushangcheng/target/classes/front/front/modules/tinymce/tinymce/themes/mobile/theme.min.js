...
!(function (l) {
  ...
  function S(n, t) {
    return Dn(n, function (n, e) {
      return { k: e, v: t(n, e) };
    });
  }
  function v(n, e) {
    return In(n, e) && n[e] !== undefined && null !== n[e];
  }
  function p(n, e) {
    var t = (function (n, e) {
  ...
  function I(n, e) {
    for (var t = 0, r = n.length; t < r; t++) {
      var o = n[t];
      if (e(o, t)) return On.some(o);
    }
    return On.none();
  }
  function A(n, e) {
    for (var t = 0, r = n.length; t < r; t++) {
      if (e(n[t], t)) return On.some(t);
    }
    return On.none();
  }
  function F(n) {
  ...
  function en(o, i) {
    ...
    return (
      ...
      function (e) {
        ...
        0 < n.length &&
          (function (n) {
            throw new Error("Unsupported keys for object: " + Z(n).join(", "));
          })(n);
        var r = {};
        return (
          C(o, function (n) {
  ...
  function on(n) {
    return (
      (n.nodeType !== nt && n.nodeType !== et) || 0 === n.childElementCount
    );
  }
  function un(n, e) {
    var t = e === undefined ? l.document : e.dom();
    return on(t) ? [] : ue(t.querySelectorAll(n), $e.fromDom);
  }
  function cn(n, e) {
    var t = e === undefined ? l.document : e.dom();
    return on(t) ? On.none() : On.from(t.querySelector(n)).map($e.fromDom);
  }
  function an(n, e) {
    return n.dom() === e.dom();
  }
  function fn(n) {
    return $e.fromDom(n.dom().ownerDocument);
  }
  function sn(n) {
    return On.from(n.dom().parentNode).map($e.fromDom);
  }
  function ln(n, e) {
    var t = n.dom().childNodes;
    return On.from(t[e]).map($e.fromDom);
  }
  function dn(e, t) {
    sn(e).each(function (n) {
      n.dom().insertBefore(t.dom(), e.dom());
    });
  }
  function mn(n, e) {
    (function (n) {
      return On.from(n.dom().nextSibling).map($e.fromDom);
    })(n).fold(
      function () {
        sn(n).each(function (n) {
          rt(n, e);
        });
      },
      function (n) {
  ...
  function yn(e, n) {
    ...
    var r = N(t, n);
    C(r, function (n) {
      it(n), e.getSystem().removeFromWorld(n);
    }),
      C(n, function (n) {
        n.getSystem().isConnected()
          ? vn(e, n)
          : (e.getSystem().addToWorld(n), vn(e, n), J(e.element()) && ut(n)),
          e.syncComponents();
      });
  }
  function bn(e) {
    var n = sn(e.element()).bind(function (n) {
      return e.getSystem().getByDom(n).toOption();
    });
    !(function (n) {
      it(n), ot(n.element()), n.getSystem().removeFromWorld(n);
    })(e),
      n.each(function (n) {
        n.syncComponents();
      });
  ...
  function xn(u) {
    return function () {
      ...
      for (var t = {}, r = 0; r < n.length; r++) {
        var o = n[r];
        for (var i in o) mt.call(o, i) && (t[i] = u(t[i], o[i]));
      }
      return t;
    };
  }
  var wn,
    ...
    On = {
      ...
      none: n,
      from: function (n) {
        return null === n || n === undefined ? f : Tn(n);
      },
    },
    kn = Object.keys,
    En = Object.hasOwnProperty,
    Cn = function (n, e) {
      for (var t = kn(n), r = 0, o = t.length; r < o; r++) {
        var i = t[r];
        e(n[i], i);
      }
    },
    ...
    Mn = function (n, e) {
      return In(n, e) ? On.from(n[e]) : On.none();
    },
    In = function (n, e) {
      return En.call(n, e);
    },
    ...
    Ln = {
      unknown: function () {
        return zn({ current: undefined, version: Bn.unknown() });
      },
      nu: zn,
      edge: b(Vn),
      chrome: b(Nn),
    ...
    Kn = {
      unknown: function () {
        return Yn({ current: undefined, version: Bn.unknown() });
      },
      nu: Yn,
      windows: b(Gn),
      ios: b("iOS"),
    ...
    se = [
      ...
      },
      {
        ...
        search: function (n) {
          return z(n, "chrome") && !z(n, "chromeframe");
        },
      },
      {
        name: "IE",
      ...
      },
      {
        ...
        search: function (n) {
          return (z(n, "safari") || z(n, "mobile/")) && z(n, "applewebkit");
        },
      },
    ],
    le = [
      ...
      { name: "Linux", search: L("linux"), versionRegexes: [] },
      { name: "Solaris", search: L("sunos"), versionRegexes: [] },
      { name: "FreeBSD", search: L("freebsd"), versionRegexes: [] },
      {
        name: "ChromeOS",
        search: L("cros"),
    ...
    me = An(
      (function (n, e) {
        var t = de.browsers(),
          ...
          i = ae(r, n).fold(Kn.unknown, Kn.nu);
        return {
          browser: o,
          os: i,
    ...
    $e = {
      fromHtml: function (n, e) {
        var t = (e || l.document).createElement("div");
        if (((t.innerHTML = n), !t.hasChildNodes() || 1 < t.childNodes.length))
          throw (
            (l.console.error("HTML does not have a single root node", n),
            new Error("HTML must have a single root node"))
          );
        return Ue(t.childNodes[0]);
      },
      fromTag: function (n, e) {
        var t = (e || l.document).createElement(n);
        return Ue(t);
      },
      fromText: function (n, e) {
        var t = (e || l.document).createTextNode(n);
        return Ue(t);
      },
      fromDom: Ue,
      fromPoint: function (n, e, t) {
        var r = n.dom();
        return On.from(r.elementFromPoint(e, t)).map(Ue);
      },
    },
    We =
    ...
    Ke = K(qe),
    Je = q(function () {
      return Qe($e.fromDom(l.document));
    }),
    Qe = function (n) {
      var e = n.dom().body;
    ...
    Ze = function (n, e) {
      return tn(n, e, l.Node.DOCUMENT_POSITION_CONTAINED_BY);
    },
    nt = Xe,
    et = We,
    tt =
      (G().browser.isIE(),
      function (n) {
        return ue(n.dom().childNodes, $e.fromDom);
      }),
    rt =
      (Q("element", "offset"),
      function (n, e) {
    ...
    dt = function (u) {
      if (!Zn(u)) throw new Error("cases must be an array");
      ...
      return (
        C(u, function (n, r) {
          ...
          if (!Zn(i)) throw new Error("case arguments must be an array");
          c.push(o),
            (t[o] = function () {
    ...
    gt = xn(function (n, e) {
      return Qn(n) && Qn(e) ? gt(n, e) : e;
    }),
    pt = xn(function (n, e) {
      return e;
    });
  ((Sn = wn = wn || {})[(Sn.Error = 0)] = "Error"),
    (Sn[(Sn.Value = 1)] = "Value");
  function ht(n, e, t) {
    return n.stype === wn.Error ? e(n.serror) : t(n.svalue);
  }
  function vt(n) {
    return { stype: wn.Value, svalue: n };
  }
  function yt(n) {
    return { stype: wn.Error, serror: n };
  }
  function bt(n) {
    return zr.defaultedThunk(b(n));
  }
  function xt(n, e) {
    var t;
    return ((t = {})[n] = e), t;
  ...
  function Ot(n, e) {
    ...
    return 0 < t.errors.length
      ...
      : (function (n, e) {
          return 0 === n.length
            ? lt.value(e)
            : lt.value(gt(e, pt.apply(undefined, n)));
        })(t.values, e);
  }
  function kt(n) {
    return i(Vr, F)(n);
  ...
  function Et(n) {
    return Qn(n) && 100 < kn(n).length
      ? " removed due to size"
      : JSON.stringify(n, null, 2);
  }
  function Ct(n, e) {
    return Vr([{ path: n, getErrorInfo: e }]);
  }
  function Dt(n, e, t) {
    return Mn(e, t).fold(function () {
      return (function (n, e, t) {
        return Ct(n, function () {
          return (
            'Could not find valid *strict* value for "' + e + '" in ' + Et(t)
          );
        });
      })(n, t, e);
    }, Rr);
    ...
    return n.fold(
      function (r, t, n, o) {
        ...
        function e(n) {
          return n.fold(
            function () {
              var n = xt(t, a(On.none()));
              return Rr(n);
            },
            function (n) {
              var e = o.extract(u.concat([r]), a, n);
              return Hr(e, function (n) {
                return xt(t, a(On.some(n)));
              });
            },
          );
        }
        return n.fold(
          function () {
            return Nr(Dt(u, c, r), i);
          },
          function (n) {
            return Nr(_t(c, r, n), i);
          },
          function () {
            return Nr(
              (function (n, e) {
    ...
    return {
      extract: function (t, r, o) {
        ...
        return Nr(e, function (n) {
          var e = ue(n, function (n) {
            return qr.field(n, n, Lr(), i);
          });
  ...
  function Bt(n, o) {
    return {
      ...
      toString: function () {
        return "chooseOn(" + n + "). Possible values: " + kn(o);
      },
    };
  }
  function Vt(e) {
    return It(function (n) {
      return e(n).fold(Vr, Rr);
    });
  }
  function Nt(e, n) {
  ...
  function Yt(n, e) {
    return Qr(n, n, bt(e), Kr());
  }
  function Kt(n, e, t) {
    return Qr(n, n, bt(e), t);
  }
  function Jt(n, e) {
    return Jr(n, e);
  }
  function Qt(n, e) {
    return an(n.element(), e.event().target());
  }
  function Zt(n) {
    if (!v(n, "can") && !v(n, "abort") && !v(n, "run"))
      throw new Error(
    ...
    return Pt(
      ...
      At([Yt("can", b(!0)), Yt("abort", b(!1)), Yt("run", w)]),
      n,
    );
  }
  function nr(t) {
  ...
  function tr(n, e) {
    return { key: n, value: Zt({ abort: e }) };
  }
  function rr(n, e) {
    return { key: n, value: Zt({ run: e }) };
  }
  function or(n, t, r) {
    return {
      key: n,
  ...
  function lr(o, i, u) {
    return (function (n, e, t) {
      ...
      return (
        (n.toFunctionAnnotation = function () {
          return { name: e, parameters: ao(u.slice(0, 1).concat(u.slice(3))) };
        }),
        n
      );
    })(
  ...
  function mr(n) {
    var e = Pt("Creating behaviour: " + n.name, go, n);
    return (function (n, e, t, r, o, i) {
      var u = At(n),
        c = Xt(e, [qt("config", n)]);
      return fo(u, c, e, t, r, o, i);
  ...
  function Sr(n, e) {
    return (function (n, e, t) {
      var r = xr(n, e).concat([t]);
      return pr(n, e, r.join(" ")), !0;
    })(n, "class", e);
  }
  function Tr(n, e) {
    return (function (n, e, t) {
      var r = D(xr(n, e), function (n) {
        return n !== t;
      });
      return 0 < r.length ? pr(n, e, r.join(" ")) : br(n, e), !1;
    })(n, "class", e);
  }
  function Or(n, e) {
    wr(n) ? n.dom().classList.add(e) : Sr(n, e);
  }
  function kr(n) {
    0 ===
      (wr(n)
  ...
  function Er(n, e) {
    wr(n) ? n.dom().classList.remove(e) : Tr(n, e), kr(n);
  }
  function Cr(n, e) {
    return wr(n) && n.dom().classList.contains(e);
  }
  function Dr(n, e, t) {
    Er(n, t), Or(n, e);
  }
  var _r,
    ...
    Vr = yt,
    Nr = function (n, e) {
      return n.stype === wn.Value ? e(n.svalue) : n;
    },
    jr = function (n, e) {
      return n.stype === wn.Error ? e(n.serror) : n;
    },
    Hr = function (n, e) {
      return n.stype === wn.Value
        ? { stype: wn.Value, svalue: e(n.svalue) }
        : n;
    },
    Pr = function (n, e) {
      return n.stype === wn.Error
        ? { stype: wn.Error, serror: e(n.serror) }
        : n;
    },
    zr = dt([
      { strict: [] },
    ...
    Wr =
      ...
      function (n, e) {
        ...
        return 0 < t.errors.length
          ? kt(t.errors)
          : (function (n, e) {
              return 0 < n.length ? Rr(gt(e, pt.apply(undefined, n))) : Rr(e);
            })(t.values, e);
      }),
    Xr = function (n) {
      var e = Br(n);
      return 0 < e.errors.length ? kt(e.errors) : Rr(e.values);
    },
    qr = dt([
    ...
    to =
      ...
      It(function (n) {
        var e = typeof n;
        return _r(n) ? Rr(n) : Vr("Expected type: " + Mr + " but got: " + e);
      })),
    ro = function (n, e, t) {
      return e(n).orThunk(function () {
        return t(n)
          ? On.none()
          : (function (n, e, t) {
              for (var r = n.dom(), o = ee(t) ? t : b(!1); r.parentNode; ) {
                r = r.parentNode;
                var i = $e.fromDom(r),
                  u = e(i);
    ...
    fo = function (t, n, r, o, e, i, u) {
      ...
      var a = S(e, function (n, e) {
        ...
        s = x(x(x({}, f), a), {
          revoke: d(dr, r),
          config: function (n) {
            var e = Pt(r + "-config", t, n);
            return {
              key: r,
              value: {
                config: e,
                me: s,
                configAsRaw: q(function () {
                  return Pt(r + "-config", t, n);
                }),
                initialConfig: n,
                state: u,
              },
          ...
          exhibit: function (n, t) {
            return c(n)
              .bind(function (e) {
                return Mn(o, "exhibit").map(function (n) {
          ...
          handlers: function (n) {
            return c(n)
              .map(function (n) {
                return Mn(o, "events").getOr(function () {
                  return {};
                })(n.config, n.state);
              })
              .getOr({});
    ...
    vo = /* */ Object.freeze({
      ...
      toAlpha: function (n, e, t) {
        Dr(n.element(), e.alpha, e.omega);
      },
      toOmega: function (n, e, t) {
        Dr(n.element(), e.omega, e.alpha);
      },
      isAlpha: function (n, e, t) {
        return Cr(n.element(), e.alpha);
      },
      isOmega: function (n, e, t) {
        return Cr(n.element(), e.omega);
      },
      clear: function (n, e, t) {
        Er(n.element(), e.alpha), Er(n.element(), e.omega);
      },
    }),
    yo = [Lt("alpha"), Lt("omega")],
    bo = mr({ fields: yo, name: "swapping", apis: vo });
  function xo(n, e, t, r, o) {
    return n(t, r) ? On.some(t) : ee(o) && o(t) ? On.none() : e(t, r, o);
  }
  function wo(n, e, t) {
    for (var r = n.dom(), o = ee(t) ? t : b(!1); r.parentNode; ) {
      r = r.parentNode;
      var i = $e.fromDom(r);
      if (e(i)) return On.some(i);
      if (o(i)) break;
    }
    return On.none();
  }
  ...
  function Oo(n) {
    var e = n !== undefined ? n.dom() : l.document;
    return On.from(e.activeElement).map($e.fromDom);
  }
  function ko(e) {
    return Oo(fn(e)).filter(function (n) {
  ...
  function Co(n, e) {
    var t = fn(n).dom(),
      ...
      o = (function (n, e) {
        var t = (e || l.document).createElement("div");
        return (t.innerHTML = n), tt($e.fromDom(t));
      })(e, t);
    pn(r, o), hn(n), rt(n, r);
  }
  function Do(n) {
    return (function (n, e) {
      return $e.fromDom(n.dom().cloneNode(e));
    })(n, !1);
  }
  function _o(n) {
    return (function (n) {
      var e = $e.fromTag("div"),
        t = $e.fromDom(n.dom().cloneNode(!0));
      return rt(e, t), Eo(e);
    })(Do(n));
  }
  function Mo(n) {
  ...
  var Io,
    Ao,
    Fo = tinymce.util.Tools.resolve("tinymce.dom.DOMUtils"),
    ...
    Bo = function (n) {
      ...
      var t = l.document.createEvent("MouseEvents");
      t.initMouseEvent(
        "click",
        !0,
        !0,
    ...
    jo = "unknown";
  ((Ao = Io = Io || {})[(Ao.STOP = 0)] = "STOP"),
    (Ao[(Ao.NORMAL = 1)] = "NORMAL"),
    (Ao[(Ao.LOGGING = 2)] = "LOGGING");
  function Ho(e, n, t) {
    switch (
      Mn(si.get(), e)
        .orThunk(function () {
          ...
          return H(n, function (n) {
            return -1 < e.indexOf(n) ? On.some(si.get()[n]) : On.none();
          });
        })
        .getOr(Io.NORMAL)
    ) {
        ...
        var r = (function (e, t) {
            ...
            return {
              ...
              write: function () {
                ...
                k(["mousemove", "mouseover", "mouseout", Ne()], e) ||
                  l.console.log(e, {
                    event: e,
                    time: n - o,
                    target: t.dom(),
                    sequence: ue(r, function (n) {
  ...
  function Yo(e, n, t) {
    n.toggleClass.each(function (n) {
      t.get() ? Or(e.element(), n) : Er(e.element(), n);
    });
  }
  function Ko(n, e, t) {
    xi(n, e, t, !t.get());
  ...
  function Jo(n, e, t) {
    t.set(!0), Yo(n, e, t), qo(n, e, t);
  }
  function Qo(n, e, t) {
    t.set(!1), Yo(n, e, t), qo(n, e, t);
  }
  function Zo(n, e, t) {
    xi(n, e, t, e.selected);
  }
  function ni() {
    ...
    return [rr(ke(), n), rr(Be(), n), cr(ge()), cr(ve())];
  }
  function ei(n, e) {
    e.ignore || (So(n.element()), e.onFocus(n));
  }
  function ti(n) {
    return n.style !== undefined && ee(n.style.getPropertyValue);
  }
  function ri(n, e, t) {
    if (!Jn(t))
      throw (
  ...
  function ui(n, e) {
    var t = n.dom(),
      r = Vi(t, e);
    return On.from(r).filter(function (n) {
      return 0 < n.length;
    });
  }
  function ci(n, e) {
    !(function (n, e) {
      ti(n) && n.style.removeProperty(e);
    })(n.dom(), e),
      yr(n, "style") &&
        "" ===
          (function (n) {
  ...
  var fi,
    ...
    vi = b(hi),
    yi = [
      Gt("channels", Nt(lt.value, At([Uo("onReceive"), Yt("schema", eo())]))),
    ],
    ...
    Si = /* */ Object.freeze({
      ...
      events: function (n, e) {
        var t = (function (e, t, r) {
          ...
          r = sr(n, e, Zo);
        return er(F([n.toggleOnExecute ? [t] : [], [r]]));
      },
    }),
    Ti = function (n, e, t) {
      ...
      Kt(
        ...
        zt("mode", {
          pressed: [
            ...
            Wo("update", function (n, e, t) {
              pr(n.element(), "aria-pressed", t),
                e.syncWithExpanded && Ti(n, e, t);
            }),
          ],
          checked: [
            Wo("update", function (n, e, t) {
              pr(n.element(), "aria-checked", t);
            }),
          ],
          expanded: [Wo("update", Ti)],
          selected: [
            Wo("update", function (n, e, t) {
              pr(n.element(), "aria-selected", t);
            }),
          ],
          none: [Wo("update", w)],
        }),
    ...
    Ci = function (n) {
      return bi.config({
        channels: St(Vo.orientationChanged(), { onReceive: n }),
      });
    },
    Di = function (n, e) {
    ...
    Vi = function (n, e) {
      return ti(n) ? n.style.getPropertyValue(e) : "";
    };
  function Ni(r, o) {
    function n(n) {
      var e = o(n);
  ...
  function $i(n, e, t) {
    return xo(rn, Gi, n, e, t);
  }
  function Wi(n, e, t) {
    var r = V(n.slice(0, e)),
      o = V(n.slice(e + 1));
    return I(r.concat(o), t);
  }
  function Xi(n, e, t) {
    var r = V(n.slice(0, e));
    return I(r, t);
  ...
  function ou(t, r, n, o) {
    var e = zi(t.element(), "." + r.highlightClass);
    C(e, function (e) {
      E(o, function (n) {
        return n.element() === e;
      }) ||
        (Er(e, r.highlightClass),
        t
          .getSystem()
          .getByDom(e)
          .each(function (n) {
            r.onDehighlight(t, n), U(n, Le());
          }));
    });
  }
  function iu(n, e, t, r) {
    ou(n, e, 0, [r]),
      mu(n, e, t, r) ||
        (Or(r.element(), e.highlightClass), e.onHighlight(n, r), U(r, ze()));
  }
  function uu(t, e, n, r) {
    var o = zi(t.element(), "." + e.itemClass);
    return A(o, function (n) {
      return Cr(n, e.highlightClass);
    }).bind(function (n) {
      var e = tu(n, r, 0, o.length - 1);
  ...
  var fu,
    su,
    lu = Ni("height", function (n) {
      var e = n.dom();
      return J(n) ? e.getBoundingClientRect().height : e.offsetHeight;
    }),
    du = m(Qi),
    mu = function (n, e, t, r) {
      return Cr(r.element(), e.highlightClass);
    },
    gu = function (n, e, t, r) {
      var o = zi(n.element(), "." + e.itemClass);
      return On.from(o[r]).fold(function () {
        return lt.error("No element found with index " + r);
    ...
    hu = function (e, n, t) {
      var r = zi(e.element(), "." + n.itemClass);
      return (0 < r.length ? On.some(r[r.length - 1]) : On.none()).bind(
        function (n) {
          return e.getSystem().getByDom(n).toOption();
        },
      );
    ...
    yu = /* */ Object.freeze({
      ...
      dehighlight: function (n, e, t, r) {
        mu(n, e, t, r) &&
          (Er(r.element(), e.highlightClass),
          e.onDehighlight(n, r),
          U(r, Le()));
      },
      highlight: iu,
      highlightFirst: function (e, t, r) {
        pu(e, t).each(function (n) {
          iu(e, t, r, n);
        });
      },
      highlightLast: function (e, t, r) {
        hu(e, t).each(function (n) {
          iu(e, t, r, n);
        });
      },
  ...
  ((su = fu = fu || {}).OnFocusMode = "onFocus"),
    (su.OnEnterOrSpaceMode = "onEnterOrSpace"),
    (su.OnApiMode = "onApi");
  function wu(n, e, t, i, u) {
    ...
    var r = {
          ...
          Kt(
            ...
            Vt(function (n) {
              return k(["onFocus", "onEnterOrSpace", "onApi"], n)
                ? lt.value(n)
                : lt.error("Invalid value for focusInside");
            }),
          ),
          Wo("handler", r),
          Wo("state", e),
      ...
      toEvents: function (r, o) {
        var n =
          r.focusInside !== fu.OnFocusMode
            ? On.none()
            : u(r).map(function (t) {
                return rr(_e(), function (n, e) {
                  t(n, r, o), e.stop();
                });
              });
        return er(
          n.toArray().concat([
            rr(we(), function (n, e) {
              c(n, e, t, r, o).fold(
                function () {
                  !(function (e, t) {
                    var n = Ki([32].concat([13]))(t.event());
                    r.focusInside === fu.OnEnterOrSpaceMode &&
                      n &&
                      Qt(e, t) &&
                      u(r).each(function (n) {
                        n(e, r, o), t.stop();
  ...
  function Su(n) {
    ...
    function e(e, t, n) {
      (function (n, e) {
        var t = zi(n.element(), e.selector),
          r = D(t, function (n) {
            return i(e, n);
          });
        return On.from(r[e.firstTabstop]);
      })(e, t).each(function (n) {
    ...
    function u(e, n, t, r, o) {
      return o(n, t, function (n) {
        ...
        function () {
          return r.cyclic ? On.some(!0) : On.none();
        },
        function (n) {
          return r.focusManager.set(e, n), On.some(!0);
        },
      );
    }
    function o(e, n, t, r) {
      var o = zi(e.element(), t.selector);
      return (function (n, e) {
        return e.focusManager.get(n).bind(function (n) {
          return $i(n, e.selector);
        });
      })(e, t).bind(function (n) {
        return A(o, d(an, n)).bind(function (n) {
          return u(e, o, n, t, r);
        });
      });
    }
    var t = [
      ...
      r = b([
        nu(Ji([Qi, Ki([9])]), function (n, e, t) {
          var r = t.cyclic ? Wi : Xi;
          return o(n, 0, t, r);
        }),
        nu(Ki([9]), function (n, e, t) {
          var r = t.cyclic ? qi : Yi;
          return o(n, 0, t, r);
        }),
        nu(Ki([27]), function (e, t, n) {
          return n.onEscape.bind(function (n) {
            return n(e, t);
          });
        }),
        nu(Ji([du, Ki([13])]), function (e, t, n) {
      ...
      c = b([]);
    return wu(t, so.init, r, c, function () {
      return On.some(e);
    });
  }
  function Tu(n) {
    return (
      ("input" === Y(n) && "radio" !== vr(n, "type")) || "textarea" === Y(n)
    );
  }
  function Ou(n, e, t) {
    return Tu(t) && Ki([32])(e.event())
      ? On.none()
      : (function (n, e, t) {
          return X(n, t, Fe()), On.some(!0);
        })(n, 0, t);
  }
  function ku(n, e) {
    return On.some(!0);
  ...
  function Cu() {
    ...
    return lo({
      ...
      setGridSize: function (n, e) {
        t.set(On.some({ numRows: b(n), numColumns: b(e) }));
      },
      getNumRows: function () {
  ...
  function Ru(n, e, t) {
    ...
    return (function (e, n) {
      return A(e, n).map(function (n) {
        return { index: b(n), candidates: b(e) };
      });
    })(D(r, Fu), function (n) {
      return an(n, e);
    });
  ...
  function Vu(t, n, r, e) {
    return e(Math.floor(n / r), n % r).bind(function (n) {
      ...
      return 0 <= e && e < t.length ? On.some(t[e]) : On.none();
    });
  }
  function Nu(o, n, i, u, c) {
    return Vu(o, n, u, function (n, e) {
      var t = n === i - 1 ? o.length - n * u : u,
        r = tu(e, c, 0, t - 1);
      return On.some({ row: b(n), column: b(r) });
    });
  }
  function ju(i, n, u, c, a) {
    return Vu(i, n, c, function (n, e) {
      var t = tu(n, a, 0, u - 1),
        r = t === u - 1 ? i.length - t * c : c,
        o = ru(e, 0, r - 1);
      return On.some({ row: b(t), column: b(o) });
    });
  }
  function Hu(e, t, n) {
  ...
  function Pu(o) {
    return function (n, e, t, r) {
      return Ru(n, e, t.selector).bind(function (n) {
        return o(
          n.candidates(),
          n.index(),
  ...
  function zu(n, e, t) {
    return t.captureTab ? On.some(!0) : On.none();
  }
  function Lu(n, e, t, o) {
    var i = function (n, e, t) {
      var r = tu(e, o, 0, t.length - 1);
      return r === n
        ? On.none()
        : (function (n) {
              return "button" === Y(n) && "disabled" === vr(n, "disabled");
            })(t[r])
          ? i(n, r, t)
          : On.from(t[r]);
    };
    return Ru(n, t, e).bind(function (n) {
      var e = n.index(),
        t = n.candidates();
      return i(e, e, t);
    });
  ...
  function Xu(o) {
    return function (n, e, t, r) {
      return o(n, e, t, r).bind(function () {
        return t.executeOnMove ? Gu(n, e, t) : On.some(!0);
      });
    };
  }
  function qu(n, e, t) {
  ...
  function Yu(n, e, t) {
    return On.from(n[e]).bind(function (n) {
      return On.from(n[t]).map(function (n) {
  ...
  function ec(n, e) {
    return function (o, t, i) {
      var u = i.cycles ? n : e;
      return $i(t, i.selectors.row).bind(function (n) {
        var e = zi(n, i.selectors.cell);
        return Bu(e, t).bind(function (t) {
          var r = zi(o, i.selectors.row);
          return Bu(r, n).bind(function (n) {
            var e = (function (n, e) {
              return ue(n, function (n) {
                return zi(n, e.selectors.cell);
              });
            })(r, i);
      ...
      ue(n, function (n) {
        return (function (e, t) {
          return Qr(
            ...
            Gr(),
            It(function (n) {
              return Vr("The field: " + e + " is forbidden. " + t);
            }),
          );
  ...
  function ac(n, e) {
    return x(x({}, n.dump), mo(e));
  }
  function fc(n) {
    return In(n, "uiType");
  }
  function sc(n, e, t, r) {
    return fc(t) && t.uiType === Ia
      ? (function (n, e, t, r) {
  ...
  function dc(n) {
    ...
    return n + "_" + Math.floor(1e9 * Math.random()) + ++Na + String(e);
  }
  function mc(n) {
    function e(n) {
      return n.name;
  ...
  function gc(t, r) {
    return function (n) {
      var e = Pt("Converting part type", r, n);
      return t(e);
    };
  }
  function pc(n, e, t, r) {
    ...
    return (
      C(n, function (n) {
        (function (n) {
          ...
          var r = nf(o, t.pname);
          e[t.name] = function (n) {
            var e = Pt("Part: " + t.name + " in " + o, Yr(t.schema), n);
    ...
    return (function (n, t, e) {
      ...
      return (
        C(e, function (n) {
          n.fold(
            function (r) {
              i[r.pname] = Ra(!0, function (n, e, t) {
                return r.factory.sketch(pc(n, r, e, t));
              });
            },
            function (n) {
              var e = t.parts[n.name];
              r[n.name] = b(n.factory.sketch(pc(t, n, e[Za()]), e));
            },
            function (r) {
              i[r.pname] = Ra(!1, function (n, e, t) {
                return r.factory.sketch(pc(n, r, e, t));
              });
            },
            function (o) {
              i[o.pname] = Ba(!0, function (e, n, t) {
                ...
                return ue(r, function (n) {
                  return o.factory.sketch(
                    gt(o.defaults(e, n, t), n, o.overrides(e, n)),
                  );
                });
              });
            },
  ...
  function yc(n, e, t) {
    return lc(On.some(n), e, e.components, t);
  }
  function bc(n, e, t) {
    var r = e.partUids[t];
  ...
  function xc(n, e, t) {
    return bc(n, e, t).getOrDie("Could not find part: " + t);
  }
  function wc(e, n) {
    var t = (function (n) {
      return ue(n, mc);
  ...
  function Oc(r) {
    return (function (n, e) {
      ...
      return (
        (n.toFunctionAnnotation = function () {
          return { name: "OVERRIDE", parameters: ao(i.slice(1)) };
        }),
        n
      );
    })(function (n) {
  ...
  function Ec(n, e, t, r, o) {
    ...
    return Pt(n + " [SpecSchema]", At(i.concat(e)), t);
  }
  function Cc(n, e, t, r, o) {
    var i = ff(o),
      u = (function (n) {
        return R(n, function (n) {
          return n
            ...
            .map(function (n) {
              return Ut(n.name, n.schema.concat([Xo(Za())]));
            })
            .toArray();
        });
      })(t),
      ...
      a = Ec(n, e, i, u, [c]),
      f = vc(0, a, t);
    return r(a, yc(n, a, f.internals()), i, f.externals());
  }
  var Dc,
    _c,
    Mc,
    ...
    zc = wu(
      ...
      so.init,
      function (n, e, t, r) {
        var o = t.useSpace && !Tu(n.element()) ? [32] : [],
          i = t.useEnter ? [13] : [],
          u = t.useDown ? [40] : [],
          c = o.concat(i).concat(u);
        return [nu(Ki(c), Eu)].concat(
          t.useControlEnter ? [nu(Ji([Zi, Ki([13])]), Eu)] : [],
        );
      },
      function (n, e, t, r) {
        return t.useSpace && !Tu(n.element()) ? [nu(Ki([32]), ku)] : [];
      },
      function () {
        return On.none();
      },
    ...
    Gc = function (n) {
      return "rtl" === ii(n, "direction") ? "rtl" : "ltr";
    },
    ...
    Yc = Pu(function (n, e, t, r) {
      return Nu(n, e, t, r, -1);
    }),
    Kc = Pu(function (n, e, t, r) {
      return Nu(n, e, t, r, 1);
    }),
    Jc = Pu(function (n, e, t, r) {
      return ju(n, e, t, r, -1);
    }),
    Qc = Pu(function (n, e, t, r) {
      return ju(n, e, t, r, 1);
    }),
    Zc = b([
      nu(Ki([37]), Mu(Yc, Kc)),
      ...
      nu(Ji([Qi, Ki([9])]), zu),
      nu(Ji([du, Ki([9])]), zu),
      nu(Ki([27]), function (n, e, t) {
        return t.onEscape(n, e);
      }),
      nu(Ki([32].concat([13])), function (e, t, r, n) {
        return (function (n, e) {
          return e.focusManager.get(n).bind(function (n) {
            return $i(n, e.selector);
          });
    ...
    na = b([nu(Ki([32]), ku)]),
    ea = wu(qc, Cu, Zc, na, function () {
      return On.some(Hu);
    }),
    ta = [
      Lt("selector"),
      Yt("getInitial", On.none),
      Yt("execute", Ou),
      Go("onEscape"),
      Yt("executeOnMove", !1),
      Yt("allowVertical", !0),
    ...
    ua = [
      Ut("selectors", [Lt("row"), Lt("cell")]),
      Yt("cycles", !0),
      Yt("previousSelector", On.none),
      Yt("execute", Ou),
    ],
    ca = ec(
      function (n, e, t) {
    ...
    la = b([
      ...
      nu(Ki([38]), $c(fa)),
      nu(Ki([40]), Wc(sa)),
      nu(Ki([32].concat([13])), function (e, t, r) {
        return ko(e.element()).bind(function (n) {
          return r.execute(e, t, n);
        });
      }),
    ]),
    da = b([nu(Ki([32]), ku)]),
    ma = wu(ua, so.init, la, da, function () {
      return On.some(nc);
    }),
    ...
    pa = b([
      nu(Ki([38]), Xc(oc)),
      nu(Ki([40]), Xc(ic)),
      nu(Ji([Qi, Ki([9])]), function (n, e, t, r) {
        return t.moveOnTab ? Xc(oc)(n, e, t, r) : On.none();
      }),
      nu(Ji([du, Ki([9])]), function (n, e, t, r) {
        return t.moveOnTab ? Xc(ic)(n, e, t, r) : On.none();
      }),
      nu(Ki([13]), tc),
      nu(Ki([32]), tc),
    ]),
    ha = b([nu(Ki([32]), ku)]),
    va = wu(ga, so.init, pa, ha, function () {
      return On.some(rc);
    }),
    ya = [
      Go("onSpace"),
    ...
    ba = wu(
      ...
      function (n, e, t) {
        return [
          nu(Ki([32]), t.onSpace),
          nu(Ji([du, Ki([13])]), t.onEnter),
          nu(Ji([Qi, Ki([13])]), t.onShiftEnter),
          nu(Ji([Qi, Ki([9])]), t.onShiftTab),
          nu(Ji([du, Ki([9])]), t.onTab),
          nu(Ki([38]), t.onUp),
          nu(Ki([40]), t.onDown),
          nu(Ki([37]), t.onLeft),
          nu(Ki([39]), t.onRight),
      ...
      function (n, e, t) {
        return t.stopSpaceKeyup ? [nu(Ki([32]), ku)] : [];
      },
      function (n) {
        return n.focusIn;
      },
    ...
    Da =
          ...
          (Vc = {
            ...
            apis: {
              ...
              setGridSize: function (n, e, t, r, o) {
                !(function (n) {
                  return v(n, "setGridSize");
                })(t)
                  ? l.console.error("Layout does not support setGridSize")
                  : t.setGridSize(r, o);
              },
            },
            state: Lc,
      ...
      (Dc = zt(Nc.branchKey, Nc.branches)),
      (_c = Nc.name),
      (Mc = Nc.active),
      (Ic = Nc.apis),
      (Ac = Nc.extra),
      (Fc = Nc.state),
      (Bc = Xt(_c, [Wt("config", (Rc = Dc))])),
      fo(Rc, Bc, _c, Mc, Ic, Ac, Fc)),
    _a = uc,
    Ma = ac,
    Ia = "placeholder",
    Aa = dt([
    ...
    Fa = function (i, u, c, a) {
      return sc(i, 0, c, a).fold(
        function (n, e) {
          var t = fc(c) ? e(u, c.config, c.validated) : e(u),
    ...
    La = Qr(
      ...
      "pname",
      Ur(function (n) {
        return "<alloy." + dc(n.name) + ">";
      }),
      eo(),
    ),
    Ga = Jt("schema", function () {
      return [$t("preprocess")];
    }),
    Ua = Yt("defaults", b({})),
    $a = Yt("overrides", b({})),
    ...
    Za = b("entirety"),
    nf = function (n, e) {
      return { uiType: Va(), owner: n, name: e };
    },
    ef = dc("alloy-premade"),
    tf = b("alloy-id-"),
    rf = b("data-alloy-id"),
    ...
    uf = rf(),
    cf = function (n, e) {
      Object.defineProperty(n.dom(), uf, { value: e, writable: !0 });
    },
    af = function (n) {
      var e = Ye(n) ? n.dom()[uf] : null;
      return On.from(e);
    },
    ff = function (n) {
      return (function (n) {
  ...
  function sf(n) {
    var e = Pt("Sketcher for " + n.name, Bs, n),
      t = S(e.apis, Oc),
  ...
  function lf(n) {
    var e = Pt("Sketcher for " + n.name, Vs, n),
      ...
      x(
        {
          ...
          configFields: b(e.configFields),
          sketch: function (n) {
            return Cc(e.name, e.configFields, e.partFields, e.factory, n);
          },
          parts: b(t),
        },
        r,
  ...
  function df(n) {
    var e = $e.fromHtml(n),
      ...
      i = 0 === t.length ? {} : { innerHtml: Eo(e) };
    return x({ tag: Y(e), classes: o, attributes: r }, i);
  }
  function mf(n) {
    return { dom: Hs(n) };
  }
  ...
  function xf() {
    ...
    return lo({
      ...
      lookup: function (n) {
        return Mn(i.get(), n).orThunk(function () {
          return Mn(u.get(), n);
        });
      },
      update: function (n) {
        ...
        C(n, function (e) {
          (r[e.value] = e),
            Mn(e, "meta").each(function (n) {
              Mn(n, "text").each(function (n) {
                o[n] = e;
              });
            });
        }),
  ...
  function Of(n) {
    ...
    if (
      ...
      return t.touches !== undefined && 1 === t.touches.length
        ? On.some(t.touches[0]).map(function (n) {
            return cl(n.clientX, n.clientY);
          })
        : On.none();
    }
    var r = e;
    return r.clientX !== undefined
      ? On.some(r).map(function (n) {
          return cl(n.clientX, n.clientY);
        })
      : On.none();
  }
  ...
  function vs(t) {
    return function (n, e) {
      return (function (n, e, t) {
        var r = (0 < n ? Zf : Qf)(Xf(t).x(), kf(t), _f(t), jf(t));
        return gs(e, ps(r)), On.some(r);
      })(t, n, e).map(function () {
        return !0;
      });
    };
  ...
  function Ss(t) {
    return function (n, e) {
      return (function (n, e, t) {
        var r = (0 < n ? Zf : Qf)(Xf(t).y(), Ef(t), Mf(t), jf(t));
        return bs(e, xs(r)), On.some(r);
      })(t, n, e).map(function () {
        return !0;
      });
    };
    ...
    return function (n, e) {
      return (function (n, e, t, r) {
        var o = 0 < n ? Zf : Qf,
          ...
          u = e ? o(Xf(r).y(), Ef(r), Mf(r), jf(r)) : Xf(r).y();
        return Os(t, ks(i, u)), On.some(i);
    ...
    return [
      (function (o) {
        ...
        return Ml.sketch({
          ...
          components: [
            Ml.parts()["left-edge"](
              mf('<div class="${prefix}-hue-slider-black"></div>'),
            ),
            Ml.parts().spectrum({
              dom: Hs(
                '<div class="${prefix}-slider-gradient-container"></div>',
              ),
              components: [mf('<div class="${prefix}-slider-gradient"></div>')],
              behaviours: mo([
                ki.config({ toggleClass: Mi.resolve("thumb-active") }),
              ]),
            }),
            Ml.parts()["right-edge"](
              mf('<div class="${prefix}-hue-slider-white"></div>'),
            ),
            Ml.parts().thumb({
              dom: Hs('<div class="${prefix}-slider-thumb"></div>'),
              behaviours: mo([
                ki.config({ toggleClass: Mi.resolve("thumb-active") }),
              ]),
            }),
          ...
          onChange: function (n, e, t) {
            var r = i(t.x());
            Bi(e.element(), "background-color", r), o.onChange(n, e, r);
          },
          ...
          onInit: function (n, e, t, r) {
            var o = i(r.x());
            Bi(e.element(), "background-color", o);
          },
          stepSize: 10,
          model: {
            mode: "x",
          ...
          sliderBehaviours: mo([Ci(Ml.refresh)]),
        });
      })(n),
    ];
  }
  function _s(e, n) {
    return (Ye(n) ? On.some(n) : sn(n).filter(Ye))
      .map(function (n) {
        return (function (n, e, t) {
          return xo(
            function (n, e) {
  ...
  var Fs,
    ...
    Ns = sf({
      ...
      factory: function (n) {
        function t(e) {
          return Mn(n.dom, "attributes").bind(function (n) {
            return Mn(n, e);
          });
        }
        var e = (function (n) {
        ...
        return {
          ...
          events: e,
          behaviours: Ma(n.buttonBehaviours, [
            Ri.config({}),
            Da.config({ mode: "execution", useSpace: !0, useEnter: !0 }),
          ]),
          domModification: {
            attributes: (function () {
    ...
    Ps = function (n, e, t, r) {
      return Ns.sketch({
        dom: pf(n, r),
        action: e,
        buttonBehaviours: gt(mo([js.config({})]), t),
      });
    },
    zs = {
      forToolbar: Ps,
    ...
    rl = [
      Kt(
        "store",
        { mode: "memory" },
        zt("mode", { memory: tl, manual: el, dataset: nl }),
      ),
      Lo("onSetValue"),
      Yt("resetOnDom", !1),
    ],
    ...
    gl = {
      ...
      top: On.none(),
      "top-right": On.none(),
      right: On.some(function (n, e) {
        Jf(n, qf(If(e)));
      }),
      "bottom-right": On.none(),
      bottom: On.none(),
      "bottom-left": On.none(),
      left: On.some(function (n, e) {
        Jf(n, qf(Cf(e)));
      }),
    },
    pl = /* */ Object.freeze({
      ...
      findValueOfOffset: hs,
      getValueFromEvent: function (n) {
        return Of(n).map(function (n) {
          return n.left();
        });
      },
    ...
    xl = {
      "top-left": On.none(),
      top: On.some(function (n, e) {
        Jf(n, Yf(Df(e)));
      }),
      "top-right": On.none(),
      right: On.none(),
      "bottom-right": On.none(),
      bottom: On.some(function (n, e) {
        Jf(n, Yf(Af(e)));
      }),
      "bottom-left": On.none(),
      left: On.none(),
    ...
    kl = Es(1, !0),
    El = {
      "top-left": On.some(function (n, e) {
        Jf(n, Kf(Cf(e), Df(e)));
      }),
      top: On.some(function (n, e) {
        Jf(n, Kf(Vf(e), Df(e)));
      }),
      "top-right": On.some(function (n, e) {
        Jf(n, Kf(If(e), Df(e)));
      }),
      right: On.some(function (n, e) {
        Jf(n, Kf(If(e), Nf(e)));
      }),
      "bottom-right": On.some(function (n, e) {
        Jf(n, Kf(If(e), Af(e)));
      }),
      bottom: On.some(function (n, e) {
        Jf(n, Kf(Vf(e), Af(e)));
      }),
      "bottom-left": On.some(function (n, e) {
        Jf(n, Kf(Cf(e), Af(e)));
      }),
      left: On.some(function (n, e) {
        Jf(n, Kf(Cf(e), Nf(e)));
    ...
    Cl = /* */ Object.freeze({
      ...
      setPositionFromValue: function (n, e, t, r) {
        var o = Xf(t),
          ...
          c = Tf(e.element()) / 2,
          a = ji(e.element()) / 2;
        Bi(e.element(), "left", i - c + "px"),
          Bi(e.element(), "top", u - a + "px");
      },
      onLeft: Sl,
      onRight: Tl,
      onUp: Ol,
      ...
      Gt(
        ...
        zt("mode", {
          ...
          xy: [
            ...
            Yt("maxY", 100),
            Jt("value", function (n) {
              return An({ x: b(n.mode.minX), y: b(n.mode.minY) });
            }),
            Lt("getInitialValue"),
            Wo("manager", Cl),
          ],
    ...
    Ml = lf({
      ...
      factory: function (i, n, e, t) {
        ...
        function c(n) {
          return xc(n, i, "spectrum");
        }
        function r(n) {
          return bc(n, i, "left-edge");
        }
        function o(n) {
          return bc(n, i, "right-edge");
        }
        function a(n) {
          return bc(n, i, "top-edge");
        }
        function f(n) {
          return bc(n, i, "bottom-edge");
        }
        function s(n, e) {
        ...
        function l(n, e) {
          h.value.set(e);
          var t = u(n);
          return s(n, t), i.onChange(n, t, e), On.some(!0);
        }
        function d(t) {
          var n = i.mouseIsDown.get();
          i.mouseIsDown.set(!1),
            n &&
              bc(t, i, "thumb").each(function (n) {
                var e = h.value.get();
                i.onChoose(t, n, e);
              });
        }
        ...
        return {
          ...
          dom: i.dom,
          components: n,
          behaviours: ac(i.sliderBehaviours, [
            Da.config({
              mode: "special",
              focusIn: function (n) {
                return bc(n, i, "spectrum").map(Da.focusIn).map(b(!0));
              },
            }),
            ol.config({
              store: {
    ...
    Fl = function (n) {
      ...
      return Ml.sketch({
        ...
        components: [
          Ml.parts().spectrum({
            dom: Hs('<div class="${prefix}-slider-size-container"></div>'),
            components: [mf('<div class="${prefix}-slider-size-line"></div>')],
          }),
          Ml.parts().thumb({
            dom: Hs('<div class="${prefix}-slider-thumb"></div>'),
            behaviours: mo([
    ...
    Bl = {
      ...
      apply: function (e, n) {
        (function (n) {
          ...
          !(function (n, e) {
            Ms(n) !== e && n.execCommand("fontSize", !1, e);
          })(e, n);
        });
      },
    },
    ...
    Nl = window.Promise
      ...
      : ((Fs =
        ...
        (jl.prototype["catch"] = function (n) {
          return this.then(null, n);
        }),
        (jl.prototype.then = function (t, r) {
          var o = this;
          return new jl(function (n, e) {
            Pl.call(o, new Ul(t, r, n, e));
          });
        }),
        (jl.all = function () {
          for (var n = [], e = 0; e < arguments.length; e++)
          ...
          var a = Array.prototype.slice.call(
            1 === n.length && Rs(n[0]) ? n[0] : n,
          );
          return new jl(function (o, i) {
        ...
        (jl.resolve = function (e) {
          return e && "object" == typeof e && e.constructor === jl
            ? e
            : new jl(function (n) {
                n(e);
              });
        }),
        (jl.reject = function (t) {
          return new jl(function (n, e) {
            e(t);
          });
        }),
    ...
    try {
      ...
      if (n && ("object" == typeof n || "function" == typeof n)) {
        ...
        if ("function" == typeof e)
          return void $l(Hl(e, n), Hl(zl, this), Hl(Ll, this));
      }
      (this._state = !0), (this._value = n), Gl.call(this);
    } catch (t) {
      Ll.call(this, t);
    }
  }
  function Ll(n) {
    (this._state = !1), (this._value = n), Gl.call(this);
  }
  function Gl() {
  ...
  function Wl(n) {
    return (function e(t) {
      return new Nl(function (n) {
        var e = new l.FileReader();
  ...
  function ql(t) {
    ...
    return Ns.sketch({
      dom: zs.getToolbarIconButton("image", t),
      components: [e.asSpec()],
      action: function (n) {
  ...
  function rd(n, e) {
    var t = As(
        dm.sketch({
          inputAttributes: { placeholder: hm.translate(e) },
          onSetValue: function (n, e) {
            U(n, Te());
          },
          inputBehaviours: mo([
            am.config({ find: On.some }),
            pm.config({}),
            Da.config({ mode: "execution" }),
          ]),
          selectOnFocus: !1,
        }),
      ),
    ...
    return {
      name: n,
      spec: fm.sketch({
        dom: Hs('<div class="${prefix}-input-container"></div>'),
        components: [t.asSpec(), r.asSpec()],
        containerBehaviours: mo([
          ki.config({ toggleClass: Mi.resolve("input-container-empty") }),
          am.config({
            find: function (n) {
              return On.some(t.get(n));
            },
          }),
          im("input-clearing", [
            rr(Te(), function (n) {
  ...
  function id(n, e) {
    return !0 === e.useNative && k(vm, Y(n.element()));
  }
  function ud(n) {
    pr(n.element(), "disabled", "disabled");
  }
  function cd(n) {
    br(n.element(), "disabled");
  }
  function ad(n) {
    pr(n.element(), "aria-disabled", "true");
  }
  function fd(n) {
    pr(n.element(), "aria-disabled", "false");
  }
  function sd(e, n, t) {
  ...
  function ld(n, e) {
    return id(n, e)
      ? (function (n) {
          return yr(n.element(), "disabled");
        })(n)
      : (function (n) {
          return "true" === vr(n.element(), "aria-disabled");
        })(n);
  }
  function dd(n) {
  ...
  function pd(n) {
    ...
    function o(n, o) {
      var i = zi(n.element(), "." + Mi.resolve("serialised-dialog-screen"));
      Ui(n.element(), "." + Mi.resolve("serialised-dialog-chain")).each(
        function (r) {
    ...
    function i(e) {
      var n = zi(e.element(), "input");
      On.from(n[c.state.currentScreen.get()]).each(function (n) {
        e.getSystem()
          .getByDom(n)
          .each(function (n) {
            !(function (n, e) {
      ...
      var t = f.get(e);
      xu.highlightAt(t, c.state.currentScreen.get());
    }
    var u = "navigateEvent",
      e = Yr([
        Lt("fields"),
        ...
        Lt("getInitialValue"),
        Jt("state", function () {
          return { dialogSwipeState: gd(), currentScreen: An(0) };
        }),
      ]),
      ...
      a = As(
        km(function (t) {
          return {
            dom: Hs('<div class="${prefix}-serialised-dialog"></div>'),
            components: [
              fm.sketch({
                dom: Hs(
                  '<div class="${prefix}-serialised-dialog-chain" style="left: 0px; position: absolute;"></div>',
                ),
                components: ue(c.fields, function (n, e) {
      ...
      f = As({
        dom: Hs('<div class="${prefix}-dot-container"></div>'),
        behaviours: mo([
          xu.config({
        ...
        components: R(c.fields, function (n, e) {
          return e <= c.maxFieldIndex
            ? [
                mf(
    ...
    return {
      dom: Hs('<div class="${prefix}-serializer-wrapper"></div>'),
      ...
      behaviours: mo([
        ...
        im("serializer-wrapper-events", [
          rr(ge(), function (n, e) {
            var t = e.event();
            c.state.dialogSwipeState.set(Em(t.raw().touches[0].clientX));
          }),
          rr(pe(), function (n, e) {
            var t = e.event();
            c.state.dialogSwipeState.on(function (n) {
              e.event().prevent(),
                c.state.dialogSwipeState.set(Cm(n, t.raw().touches[0].clientX));
            });
          }),
          rr(he(), function (r) {
            c.state.dialogSwipeState.on(function (n) {
      ...
      return function () {
        throw new Error(
          "The component must be in a context to send: " +
            n +
            (e ? "\n" + Mo(e().element()) + " is not in context." : ""),
        );
      };
    }
    return {
  ...
  function Sd(n) {
    var i = (function (n) {
      return ee(n) ? { can: b(!0), abort: b(!1), run: n } : n;
    })(n);
    return function (n, e) {
  ...
  function Td(n, e, t) {
    var r = e[t];
    return r
      ? yd("Event: " + t, "name", n, r).map(function (n) {
          var e = ue(n, function (n) {
            return n.handler();
          });
          return nr(e);
  ...
  function Cd(n, e) {
    return (function (e, n) {
      var t = ue(n, function (n) {
          return Xt(n.name(), [Lt("config"), Yt("state", so)]);
        }),
        r = jt("component.behaviours", Yr(t), e.behaviours).fold(
          function (n) {
            throw new Error(
  ...
  function _d(n, e, t) {
    var r = (function (n) {
        return x(x({}, n.dom), {
          uid: n.uid,
          domChildren: ue(n.components, function (n) {
            return n.element();
          }),
        });
      })(n),
      ...
      0 < e.length
        ? (function (e, n, t, r) {
            ...
            var u = vd(o, function (n, e) {
              ...
              a = i(u.attributes),
              f = i(u.styles);
            return fr({ classes: c, attributes: a, styles: f });
          })(t, i, e, r)
        : o,
    );
  }
  ...
  function Ad(n) {
    var e = Fm(n),
      ...
      r = u(e, ["events"]),
      o = (function (n) {
        var e = Mn(n, "components").getOr([]);
        return ue(e, Hm);
      })(r),
      i = x(x({}, r), { events: x(x({}, Am), t), components: o });
    return lt.value(Id(i));
  }
  function Fd(n) {
    var e = $e.fromText(n);
    return Nm({ element: e });
  ...
  function Rd(n) {
    (ko(n.element()).isNone() || Ri.isFocused(n)) &&
      (Ri.isFocused(n) || Ri.focus(n), $(n, zm, { item: n }));
  }
  function Bd(n) {
    $(n, Lm, { item: n });
  }
          ...
          : (function (n, o) {
              var i = function (n) {
                for (var e = 0; e < n.childNodes.length; e++) {
                  var t = $e.fromDom(n.childNodes[e]);
                  if (o(t)) return On.some(t);
  ...
  function jd(n, e, t, r) {
    var o = ng(n);
    I(o, function (n) {
      return an(r.element(), n.element());
    }).each(bn);
  }
  function Hd(e, n, t, r, o) {
    var i = ng(e);
    return On.from(i[r]).map(function (n) {
      return (
        jd(e, 0, 0, n),
        o.each(function (n) {
          Nd(
  ...
  function Pd(n, e) {
    ...
    return S(t, function (n) {
      return Mn(i, n).getOr([n]);
    });
  }
  function zd(n, e, t, r) {
    return Mn(e.routes, r.start).bind(function (n) {
      return Mn(n, r.destination);
    });
  }
  function Ld(t, r, n) {
    (function (e, t, r) {
      return ag(e, t).bind(function (n) {
        return cg(e, t, r, n);
      });
  ...
  function Gd(n, e, t, r) {
    Ld(n, e, t),
      yr(n.element(), e.stateAttr) &&
        vr(n.element(), e.stateAttr) !== r &&
        e.onFinish(n, r),
      pr(n.element(), e.stateAttr, r);
  }
  function Ud(n) {
    return Mn(n, "format").getOr(n.title);
  }
  function $d(n) {
    return v(n, "items")
      ? (function (n) {
          var e = gt(wt(n, ["items"]), { menu: !0 }),
            t = yg(n.items);
          return {
            item: e,
            menus: gt(t.menus, St(n.title, t.items)),
            expansions: gt(t.expansions, St(n.title, n.title)),
          };
        })(n)
  ...
  function Xd(n) {
    var e = n.toolbar !== undefined ? n.toolbar : Sg;
    return Zn(e) ? Tg(e) : Wd(e);
  }
  function qd(n) {
    function e() {
      n.stopPropagation();
  ...
  function Yd(n, e, t, r, o) {
    var i = (function (e, t) {
      return function (n) {
        e(n) && t(qd(n));
      };
    })(t, r);
    return n.dom().addEventListener(e, i, o), { unbind: d(Eg, n, e, i, o) };
  }
  function Kd(n, e, t) {
    return (function (n, e, t, r) {
      return Yd(n, e, t, r, !1);
  ...
  var Zd,
    nm,
    em = function (n) {
      var e = $e.fromDom(n.selection.getStart());
      return $i(e, "a");
    },
    tm = {
      getInfo: function (n) {
        ...
        o.url
          ...
          .fold(
            ...
            function (t) {
              ...
              o.link.bind(y).fold(
                function () {
                  var n = o.text.toOption().filter(Kl).getOr(t);
    ...
    sm = sf({
      ...
      factory: function (t) {
        return {
          uid: t.uid,
          dom: t.dom,
          behaviours: Ma(t.dataBehaviours, [
            ol.config({
          ...
          events: er([
            oo(function (n, e) {
              ol.setValue(n, t.getInitialValue());
            }),
          ]),
        };
      },
    ...
    mm = /* */ Object.freeze({
      __proto__: null,
      exhibit: function (n, e) {
        return fr({ attributes: Tt([{ key: e.tabAttr, value: "true" }]) });
      },
    }),
    ...
    xm = /* */ Object.freeze({
      ...
      exhibit: function (n, e) {
        return fr({
          classes: e.disabled ? e.disableClass.map(j).getOr([]) : [],
        });
      },
      events: function (t, n) {
        return er([
    ...
    Om = function (r, n) {
      return {
        ...
        dom: r.dom,
        components: n,
        behaviours: ac(r.formBehaviours, [
          ol.config({
            store: {
              mode: "manual",
              getValue: function (n) {
              ...
              setValue: function (t, n) {
                Cn(n, function (e, n) {
                  bc(t, r, n).each(function (n) {
                    am.getCurrent(n).each(function (n) {
                      ol.setValue(n, e);
                    });
                  });
                });
        ...
        apis: {
          getField: function (n, e) {
            return bc(n, r, e).bind(am.getCurrent);
          },
        },
      };
    },
    km =
      ...
      function (n) {
        var t,
          ...
          o = e.record(),
          i = ue(o, function (n) {
            return Ka({ name: n, pname: dd(n) });
          });
        return Cc("form", Tm, i, Om, r);
      }),
    Em = function (n) {
      ...
      return [
        {
          ...
          items: [
            pd({
              fields: [
                rd("url", "Type or paste URL"),
                rd("text", "Link text"),
                rd("title", "Link title"),
                rd("target", "Link target"),
                (function (n) {
                  return {
                    name: n,
                    spec: sm.sketch({
    ...
    Vm = function (n, i) {
      var e = _n(n, function (r, o) {
        return (1 === r.length ? lt.value(r[0].handler()) : Td(r, i, o)).map(
          function (n) {
            var e = Sd(n),
              t =
                1 < r.length
    ...
    Nm = function (n) {
      var e = Pt("external.component", At([Lt("element"), $t("uid")]), n),
        t = An(hd());
    ...
    Hm = function (e) {
      return (function (n) {
        ...
        function () {
          var n = e.hasOwnProperty("uid") ? e : x({ uid: jm("") }, e);
          return Ad(n).getOrDie();
        },
        function (n) {
          return n;
        },
    ...
    $m = [
      ...
      Yt("hasSubmenu", !1),
      $t("toggling"),
      _a("itemBehaviours", [ki, Ri, Da, ol]),
      Yt("ignoreFocus", !1),
      Yt("domModification", {}),
      Wo("builder", function (n) {
        return {
          dom: n.dom,
          ...
          behaviours: Ma(n.itemBehaviours, [
            n.toggling.fold(ki.revoke, function (n) {
              return ki.config(x({ aria: { mode: "checked" } }, n));
            }),
            Ri.config({
            ...
            Da.config({ mode: "execution" }),
            ol.config({ store: { mode: "memory", initialValue: n.data } }),
            im(
              "item-type-events",
              (function a() {
    ...
    qm = [
      ...
      Yt("autofocus", !1),
      Yt("ignoreFocus", !1),
      _a("widgetBehaviours", [ol, Ri, Da]),
      Yt("domModification", {}),
      Sc(Xm()),
      Wo("builder", function (t) {
        function r(n) {
          return bc(n, t, "widget").map(function (n) {
            return Da.focusIn(n), n;
          });
        }
        function n(n, e) {
          return (
            Tu(e.event().target()) || (t.autofocus && e.setSource(n.element())),
            On.none()
          );
        }
        var e = vc(0, t, Xm()),
          o = yc("item-widget", t, e.internals());
        return {
          dom: t.dom,
          components: o,
          ...
          events: er([
            ...
            rr(xe(), Rd),
            rr(Re(), function (n, e) {
              t.autofocus ? r(n) : Ri.focus(n);
            }),
          ]),
          behaviours: Ma(t.widgetBehaviours, [
            ol.config({ store: { mode: "memory", initialValue: t.data } }),
            Ri.config({
            ...
            Da.config({
              ...
              onEscape: function (n, e) {
                return Ri.isFocused(n) || t.autofocus
                  ? (t.autofocus && e.setSource(n.element()), On.none())
                  : (Ri.focus(n), On.some(!0));
              },
            }),
          ]),
        };
    ...
    Km = b([
      Qa({
        ...
        defaults: function (n, e) {
          return e.hasOwnProperty("uid") ? e : x(x({}, e), { uid: kc("item") });
        },
    ...
    Zm = lf({
      ...
      factory: function (n, e, t, r) {
        return {
          ...
          dom: n.dom,
          markers: n.markers,
          behaviours: ac(n.menuBehaviours, [
            xu.config({
              highlightClass: n.markers.selectedItem,
              itemClass: n.markers.item,
              onHighlight: n.onHighlight,
            }),
            ol.config({ store: { mode: "memory", initialValue: n.value } }),
            am.config({ find: On.some }),
            Da.config(n.movement.config(n, n.movement)),
          ]),
          events: er([
            rr(Um(), function (e, t) {
              var n = t.event();
    ...
    tg = function (t, r, o, n) {
      return Mn(o, n)
        .bind(function (n) {
          return Mn(t, n).bind(function (n) {
            var e = tg(t, r, o, n);
            return On.some([n].concat(e));
          });
        })
        .getOr([]);
    },
      ...
      init: function () {
        ...
        return {
          ...
          setContents: function (n, e, t, r) {
            a.set(On.some(n)), i.set(t), u.set(e), f.set(r);
            var o = Pd(r, t);
            c.set(o);
          },
          expand: function (t) {
            return Mn(i.get(), t).map(function (n) {
              var e = Mn(c.get(), t).getOr([]);
              return [n].concat(e);
            });
          },
          refresh: function (n) {
          ...
          collapse: function (n) {
            return Mn(c.get(), n).bind(function (n) {
          ...
          clear: function () {
            i.set({}), u.set({}), c.set({}), a.set(On.none());
          },
          isClear: function () {
            return a.get().isNone();
          },
    ...
    ug = sf({
      ...
      configFields: [
        ...
        Ut("data", [Lt("primary"), Lt("menus"), Lt("expansions")]),
        Yt("fakeFocus", !1),
        Lo("onHighlight"),
        Lo("onHover"),
        Ut("markers", [Lt("backgroundMenu")].concat(mi()).concat(gi())),
        Lt("dom"),
        Yt("navigateOnHover", !0),
        Yt("stayInDom", !1),
        uc("tmenuBehaviours", [Da, xu, am, eg]),
        Yt("eventOrder", {}),
      ],
      apis: {
      ...
      factory: function (c, n) {
              ...
              return Zm.sketch(
                x(x({ dom: n.dom }, n), {
                  ...
                  focusManager: c.fakeFocus
                    ? (function () {
                        function o(n) {
                          return xu.getHighlighted(n).map(function (n) {
                            return n.element();
                          });
                        }
                        return {
        ...
        function s(e, n, t) {
          ...
          C(r, function (n) {
            Ed(n.element(), [c.markers.backgroundMenu]),
          ...
          var e = (function (r) {
            return o.get().getOrThunk(function () {
              var t = {},
                ...
                e = D(n, function (n) {
                  return "true" === vr(n, "aria-haspopup");
                });
              return (
                C(e, function (n) {
                  r.getSystem()
        ...
        function d(r, o, i) {
          return On.from(i[0]).bind(function (n) {
            return o.lookupMenu(n).bind(function (n) {
              ...
              return (
                C(t, function (n) {
                  Or(n.element(), c.markers.backgroundMenu);
                }),
                J(e.element()) || eg.append(r, Pm(e)),
                Ed(e.element(), [c.markers.backgroundMenu]),
                u(r, e),
                s(r, o, i),
                On.some(e)
              );
            ...
            return (
              ...
              On.from(r[0]).bind(function (t) {
                return g.lookupMenu(t).bind(function (n) {
                  ...
                  return (
                    J(e.element()) || eg.append(o, Pm(e)),
                    c.onOpenSubmenu(o, i, e, V(r)),
                    u === m.HighlightSubmenu
                      ? (xu.highlightFirst(e), d(o, g, r))
                      : (xu.dehighlightAll(e), On.some(i))
                  );
                });
              })
            );
        ...
        function t(t) {
          return function (e, n) {
            return $i(n.getSource(), "." + c.markers.item).bind(function (n) {
              return e
                .getSystem()
                .getByDom(n)
                .toOption()
        ...
        function v(n) {
          return xu.getHighlighted(n).bind(xu.getHighlighted);
        }
        var y = er(
            [
              rr(Qm(), function (t, r) {
          ...
          behaviours: ac(c.tmenuBehaviours, [
            Da.config({
              ...
              onLeft: t(function (n, e) {
                return Tu(e.element()) ? On.none() : h(n, e);
              }),
      ...
      extraApis: {
        ...
        collapseItem: function (n) {
          return { value: dc(ig()), meta: { text: n } };
        },
      },
    }),
    cg = function (n, e, t, r) {
      return zd(0, e, 0, r).bind(function (e) {
    ...
    ag = function (n, e, t) {
      var r = n.element();
      return yr(r, e.destinationAttr)
        ? On.some({
            start: vr(n.element(), e.stateAttr),
            destination: vr(n.element(), e.destinationAttr),
          })
        : On.none();
    },
    fg = /* */ Object.freeze({
      ...
      progressTo: function (t, r, o, i) {
        !(function (n, e) {
          yr(n.element(), e.destinationAttr) &&
            (pr(n.element(), e.stateAttr, vr(n.element(), e.destinationAttr)),
            br(n.element(), e.destinationAttr));
        })(t, r);
        var n = (function (n, e, t, r) {
          return { start: vr(n.element(), e.stateAttr), destination: r };
        })(t, r, 0, i);
        cg(t, r, o, n).fold(
          function () {
            Gd(t, r, o, i);
          ...
          function (n) {
            Ld(t, r, o);
            var e = n.transition;
            Or(t.element(), e.transitionClass),
              pr(t.element(), r.destinationAttr, i);
          },
        );
      },
      getState: function (n, e, t) {
        var r = n.element();
        return yr(r, e.stateAttr) ? On.some(vr(r, e.stateAttr)) : On.none();
      },
    }),
    sg = /* */ Object.freeze({
      __proto__: null,
      events: function (o, i) {
        return er([
          rr(Ee(), function (t, n) {
            var r = n.event().raw();
            ag(t, o).each(function (e) {
              zd(0, o, 0, e).each(function (n) {
                n.transition.each(function (n) {
                  r.propertyName === n.property &&
                    (Gd(t, o, i, e.destination), o.onTransition(t, e));
                });
              });
            });
          }),
          oo(function (n, e) {
            Gd(n, o, i, o.initialState);
          }),
        ]);
      },
    }),
    lg = [
      ...
      Gt(
        ...
        Nt(
          ...
          Nt(
            lt.value,
            At([qt("transition", [Lt("property"), Lt("transitionClass")])]),
          ),
        ),
      ),
    ],
      ...
      return {
        ...
        components: [
          ...
          }),
          {
            ...
            components: [Zm.parts().items({})],
            behaviours: mo([
              im("adhoc-scrollable-menu", [
                oo(function (n, e) {
                  Bi(n.element(), "overflow-y", "auto"),
                    Bi(n.element(), "-webkit-overflow-scrolling", "touch"),
                    gg.register(n.element());
                }),
                io(function (n) {
                  ci(n.element(), "overflow-y"),
                    ci(n.element(), "-webkit-overflow-scrolling"),
                    gg.deregister(n.element());
                }),
              ]),
            ]),
          },
        ...
        menuBehaviours: mo([
          dg.config({
            initialState: "after",
            routes: dg.createTristate("before", "current", "after", {
              transition: {
                property: "transform",
    ...
    vg = function (r) {
      var n = (function (r, o) {
          var n = hg(
            ...
            t = gt(e, St("styles", n));
          return { tmenu: ug.tieredData("styles", t, r.expansions) };
        })(r.formats, function () {
          return e;
        }),
        e = As(
          ug.sketch({
            ...
            onExecute: function (n, e) {
              var t = ol.getValue(e);
              return r.handle(e, t.value), On.none();
            },
            onEscape: function () {
              return On.none();
            },
            onOpenMenu: function (n, e) {
              var t = Tf(n.element());
              Sf(e.element(), t), dg.jumpTo(e, "current");
            },
            onOpenSubmenu: function (n, e, t) {
              ...
              Sf(t.element(), r),
                dg.progressTo(i, "before"),
                dg.jumpTo(t, "after"),
                dg.progressTo(t, "current");
            },
            onCollapseMenu: function (n, e, t) {
              var r = Gi(e.element(), '[role="menu"]').getOrDie("hacky"),
                o = n.getSystem().getByDom(r).getOrDie();
              dg.progressTo(o, "after"), dg.progressTo(t, "current");
            },
            navigateOnHover: !1,
    ...
    yg = function (n) {
      return _(
        ...
        function (n, e) {
          var t = $d(e);
          return {
            menus: gt(n.menus, t.menus),
            items: [t.item].concat(n.items),
            expansions: gt(n.expansions, t.expansions),
          };
        },
    ...
    xg = function (r, n) {
      ...
      var e = Mn(n, "style_formats").getOr(Mm),
        t = function (n) {
          return ue(n, function (n) {
            if (v(n, "items")) {
              var e = t(n.items);
              return gt(
                (function (n) {
                  return gt(n, { isSelected: b(!1), getPreview: b("") });
                })(n),
                { items: e },
              );
            }
        ...
        var t = function (n) {
            return R(n, function (n) {
              return n.items === undefined
                ? !v(n, "format") || e.formatter.canApply(n.format)
                  ? [n]
                  : []
                : 0 < t(n.items).length
                  ? [n]
    ...
    Tg = function (n) {
      return R(n, function (n) {
        return Zn(n) ? Tg(n) : Wd(n);
      });
    },
    Og = function (e, r) {
      function n(n) {
        return function () {
          return zs.forToolbarCommand(r, n);
        };
      }
      function t(n) {
        return function () {
          return zs.forToolbarStateCommand(r, n);
        };
      }
      function o(n, e, t) {
        return function () {
          return zs.forToolbarStateAction(r, n, e, t);
        };
      }
      function i() {
        return wg(r, h, function () {
      ...
      return {
        ...
        bold: u(On.none(), f),
        italic: u(On.none(), s),
        underline: u(On.none(), l),
        removeformat: u(On.none(), d),
        link: u(On.none(), function () {
          return (function (e, t) {
            return zs.forToolbarStateAction(t, "link", "link", function () {
              var n = _m(e, t);
              e.setContextToolbar(n),
                om(t, function () {
                  e.focusToolbar();
                }),
                tm.query(t).each(function (n) {
        ...
        unlink: u(On.none(), m),
        image: u(On.none(), function () {
          return ql(r);
        }),
        bullist: u(On.some("bullist"), g),
        numlist: u(On.some("numlist"), p),
        fontsizeselect: u(On.none(), function () {
          return (function (n, e) {
            var t = {
              onChange: function (n) {
                Bl.apply(e, n);
        ...
        forecolor: u(On.none(), function () {
          return Il(e, r);
        }),
        styleselect: u(On.none(), function () {
          return zs.forToolbar(
            "style-formats",
            function (n) {
              r.fire("toReading"), e.dropup().appear(i, ki.on, n);
            },
            mo([
              ki.config({
                toggleClass: Mi.resolve("toolbar-button-selected"),
              ...
              bi.config({
                channels: Tt([
                  Di(Vo.orientationChanged(), ki.off),
                  Di(Vo.dropupDismissed(), ki.off),
                ]),
              }),
            ]),
            r,
    ...
    kg = function (n, t) {
      ...
      return R(e, function (n) {
        var e =
          !v(r, n) && v(t, n) && t[n].isSupported() ? [t[n].sketch()] : [];
        return (r[n] = !0), e;
      });
    },
    Eg = function (n, e, t, r) {
    ...
    Mg = function (r, e) {
      var n = $e.fromDom(r),
        o = null,
        t = Kd(n, "orientationchange", function () {
          Dg.clearInterval(o);
          var n = Qd(r);
          e.onChange(n),
            i(function () {
        ...
        i = function (n) {
          ...
          var e = r.innerHeight,
            t = 0;
          o = Dg.setInterval(function () {
            e !== r.innerHeight
              ? (Dg.clearInterval(o), n(On.some(r.innerHeight)))
              : 20 < t && (Dg.clearInterval(o), n(On.none())),
              t++;
          }, 50);
        };
      return {
      ...
      u = Tt([
        {
          ...
          value: function (t) {
            return (
              Ag(t).each(function (n) {
                i.cancel();
                var e = { x: b(n.clientX), y: b(n.clientY), target: t.target };
                i.schedule(t), o.set(!1), r.set(On.some(e));
              }),
              On.none()
            );
          },
        ...
        },
        {
          ...
          value: function (e) {
            ...
            return r
              .get()
              .filter(function (n) {
                return an(n.target(), e.target());
              })
              .map(function (n) {
                return o.get() ? (e.prevent(), !1) : t.triggerEvent(Be(), e);
              });
          },
        },
      ]);
  ...
  var Rg = function (t) {
      ...
      return {
        ...
        onTouchend: function () {
          return Kd(t.body(), "touchend", function (n) {
            e.fireIfReady(n, "touchend");
          });
        },
        onTouchmove: function () {
          return Kd(t.body(), "touchmove", function (n) {
    ...
    Vg = function (r, e, t) {
      function o(n) {
        return !an(n.start(), n.finish()) || n.soffset() !== n.foffset();
      }
      function n() {
      ...
      var i = Rg(r),
        u = fn(e),
        c = [
          Kd(r.body(), "touchstart", function (n) {
            r.onTouchContent(), i.fireTouchstart(n);
          }),
          i.onTouchmove(),
          i.onTouchend(),
          Kd(e, "touchstart", function (n) {
            r.onTouchToolstrip();
          }),
          ...
          !0 == Bg
            ? []
            : [
                Kd($e.fromDom(r.win()), "blur", function () {
                  t.getByDom(e).each(ki.off);
                }),
                Kd(u, "select", n),
                Kd(r.doc(), "selectionchange", n),
              ],
        );
      return {
        destroy: function () {
  ...
  function Lg(n, e, t) {
    return e(
      $e.fromDom(t.startContainer),
      t.startOffset,
      $e.fromDom(t.endContainer),
      t.endOffset,
    );
  }
  function Gg(n, e) {
  ...
  function Wg(n, e, t, r, o) {
    !(function (n, e) {
      On.from(n.getSelection()).each(function (n) {
        n.removeAllRanges(), n.addRange(e);
      });
    })(n, Pg(n, e, t, r, o));
  }
  function Xg(n, e, t, r, o) {
    !(function (u, n) {
      Gg(u, n).match({
      ...
      (function (n, e, t, r) {
        var o = Ug(n, e),
          i = Ug(t, r);
        return yp.relative(o, i);
      })(e, t, r, o),
    );
  }
  function qg(n) {
    var e = $e.fromDom(n.anchorNode),
      t = $e.fromDom(n.focusNode);
    return $g(e, n.anchorOffset, t, n.focusOffset)
      ? On.some(gp.create(e, n.anchorOffset, t, n.focusOffset))
      : (function (n) {
          if (0 < n.rangeCount) {
  ...
  function Kg(n, e) {
    return (function (n) {
      ...
      return 0 < t.width || 0 < t.height ? On.some(t).map(zg) : On.none();
    })(
      (function (i, n) {
        return Gg(i, n).match({
          ltr: function (n, e, t, r) {
  ...
  function ep(n, e) {
    var t = (function (n) {
      ...
      r = n.innerHeight;
    return r < t ? On.some(t - r) : On.none();
  }
  function tp(n) {
    return On.some($e.fromDom(n.dom().contentWindow.document.body));
  }
  function rp(n) {
    return On.some($e.fromDom(n.dom().contentWindow.document));
  }
  function op(n) {
    return On.from(n.dom().contentWindow);
  }
  function ip(n) {
    return op(n).bind(Yg);
  }
  ...
  var dp,
    mp = (function zv(t, r) {
      var e = function (n) {
        return t(n) ? On.from(n.dom().nodeValue) : On.none();
      };
      return {
        get: function (n) {
          if (!t(n))
    ...
    yp = {
      domRange: vp.domRange,
      relative: vp.relative,
      exact: vp.exact,
      ...
      getWin: function (n) {
        return (function (n) {
          return $e.fromDom(n.dom().ownerDocument.defaultView);
        })(
          (function (n) {
            return n.match({
              domRange: function (n) {
                return $e.fromDom(n.startContainer);
              },
              relative: function (n, e) {
                return hp.getStart(n);
              },
              exact: function (n, e, t, r) {
                return n;
              },
    ...
    xp =
      ...
      function (n) {
        ...
        return e !== undefined && 0 < e.rangeCount
          ? (function (t) {
              if (t.collapsed) {
                var r = $e.fromDom(t.startContainer);
                return sn(r)
                  .bind(function (n) {
                    var e = yp.exact(r, t.startOffset, n, jg(n));
                    return Kg(t.startContainer.ownerDocument.defaultView, e)
                      .map(Jg)
                      .map(j);
                  })
                  .getOr([]);
              }
              return ue(t.getClientRects(), Qg);
            })(e.getRangeAt(0))
          : [];
      }),
    wp = function (n) {
      n.focus();
      var e = $e.fromDom(n.document.body);
      (Oo().exists(function (n) {
        return k(["input", "textarea"], Y(n));
      })
        ? function (n) {
            Dg.setTimeout(function () {
              n();
            }, 0);
          }
        : t)(function () {
    ...
    Tp = function (n, r) {
      var e = $e.fromDom(r.document.body),
        t = Kd($e.fromDom(n), "resize", function () {
          ep(n, e).each(function (t) {
            (function (n) {
              var e = xp(n);
              return 0 < e.length ? On.some(e[0]).map(np) : On.none();
            })(r).each(function (n) {
              var e = (function (n, e, t) {
    ...
    Op = {
      getBody: cp("getBody", tp),
      getDoc: cp("getDoc", rp),
      getWin: cp("getWin", op),
      getSelection: cp("getSelection", ip),
      getFrame: up,
      getActiveApi: function (c) {
        var a = up(c);
        return tp(a).bind(function (u) {
          return rp(a).bind(function (i) {
            return op(a).map(function (o) {
              var n = $e.fromDom(i.dom().documentElement),
                e = c.getCursorBox.getOrThunk(function () {
                  return function () {
                    return (function (n) {
                      return Yg(n).map(function (n) {
                        return yp.exact(
                          n.start(),
                          n.soffset(),
                          n.finish(),
                      ...
                      return Kg(o, n).orThunk(function () {
                        return (function (n) {
                          return Yg(n)
                            .filter(function (n) {
                              return (
              ...
              return {
                ...
                clearSelection: r,
                frame: b(a),
                onKeyup: ap(c, i, "onKeyup", "keyup"),
                onNodeChanged: ap(c, i, "onNodeChanged", "SelectionChange"),
    ...
    Mp = function () {
      ...
      C(n, function (n) {
        var e = vr(n, kp);
        "no-styles" !== e ? pr(n, "style", e) : br(n, "style"), br(n, kp);
      });
    },
    Ip = function () {
      var e = Li("head").getOrDie(),
        n = Li('meta[name="viewport"]').getOrThunk(function () {
          var n = $e.fromTag("meta");
          return pr(n, "name", "viewport"), rt(e, n), n;
        }),
        t = vr(n, "content");
      return {
        maximize: function () {
        ...
        restore: function () {
          t !== undefined && null !== t && 0 < t.length
            ? pr(n, "content", t)
            : pr(n, "content", "user-scalable=yes");
        },
      };
    },
    Ap = function (e, n) {
      ...
      return {
        enter: function () {
          n.hide(),
            Or(e.container, Mi.resolve("fullscreen-maximized")),
            Or(e.container, Mi.resolve("android-maximized")),
            t.maximize(),
            Or(e.body, Mi.resolve("android-scroll-reload")),
            r.set(Tp(e.win, Op.getWin(e.editor).getOrDie("no"))),
            Op.getActiveApi(e.editor).each(function (n) {
              _p(e.container, n.body()), o.set(Vg(n, e.toolstrip, e.alloy));
            });
        },
        exit: function () {
          t.restore(),
            n.show(),
            Er(e.container, Mi.resolve("fullscreen-maximized")),
            Er(e.container, Mi.resolve("android-maximized")),
            Mp(),
            Er(e.body, Mi.resolve("android-scroll-reload")),
            o.clear(),
            r.clear();
        },
      };
    ...
    Fp = function (n, e) {
      ...
      return fm.sketch({
        dom: Hs('<div class="${prefix}-disabled-mask"></div>'),
        components: [
          fm.sketch({
            dom: Hs('<div class="${prefix}-content-container"></div>'),
            components: [
              Ns.sketch({
                dom: Hs('<div class="${prefix}-content-tap-section"></div>'),
                components: [t.asSpec()],
                action: function (n) {
                  r.throttle();
                },
    ...
    Rp = Yr([
      Ut("editor", [
        ...
        Yt("onTouchContent", w),
        Yt("onTapContent", w),
        Yt("onTouchToolstrip", w),
        Yt("onScrollToCursor", b({ unbind: w })),
        Yt("onScrollToElement", b({ unbind: w })),
        Yt("onToEditing", b({ unbind: w })),
        Yt("onToReading", b({ unbind: w })),
        Yt("onToolbarScrollStart", y),
      ]),
      Lt("socket"),
      Lt("toolstrip"),
      Lt("dropup"),
      ...
      Lt("alloy"),
      Jt("win", function (n) {
        return fn(n.socket).dom().defaultView;
      }),
      Jt("body", function (n) {
        return $e.fromDom(n.socket.dom().ownerDocument.body);
      }),
      Yt("translate", y),
      Yt("setReadOnly", w),
      Yt("readOnlyOnInit", b(!0)),
    ]),
    Bp = function (n) {
      var e = Pt("Getting AndroidWebapp schema", Rp, n);
      Bi(e.toolstrip, "width", "100%");
      var t = Hm(
        Fp(function () {
    ...
    Np = b([
      Ja({
        name: "groups",
        overrides: function () {
          return { behaviours: mo([eg.config({})]) };
        },
      }),
    ]),
    jp = lf({
      ...
      factory: function (e, n, t, r) {
        var o = function (n) {
            return e.shell ? On.some(n) : bc(n, e, "groups");
          },
          i = e.shell
        ...
        return {
          ...
          behaviours: ac(e.toolbarBehaviours, i.behaviours),
          apis: {
    ...
    Hp = b([
      Lt("items"),
      ((dp = ["itemSelector"]), Ut("markers", ue(dp, Lt))),
      uc("tgroupBehaviours", [Da]),
    ]),
    ...
    zp = lf({
      ...
      factory: function (n, e, t, r) {
        return {
          ...
          dom: n.dom,
          components: e,
          behaviours: ac(n.tgroupBehaviours, [
            Da.config({ mode: "flow", selector: n.markers.itemSelector }),
          ]),
    ...
    Gp = {
      exclusive: function (n, e) {
        return Kd(n, "touchmove", function (n) {
          $i(n.target(), e)
            .filter(lp)
            .fold(function () {
  ...
  function Up() {
    function e(n) {
      ...
      return {
        ...
        tgroupBehaviours: mo([
          im(
            ...
            !0 === n.scrollable
              ? [
                  uo(function (n, e) {
                    Bi(n.element(), "overflow-x", "auto"),
                      Gp.markAsHorizontal(n.element()),
                      gg.register(n.element());
                  }),
                ]
              : [],
        ...
        components: [fm.sketch({ components: [zp.parts().items({})] })],
        markers: { itemSelector: "." + Mi.resolve("toolbar-group-item") },
        items: n.items,
      };
    }
    function t() {
      jp.setGroups(r, o.get()), ki.off(r);
    }
    var r = Hm(
        jp.sketch({
          dom: Hs('<div class="${prefix}-toolbar"></div>'),
          components: [jp.parts().groups({})],
          toolbarBehaviours: mo([
            ki.config({
              toggleClass: Mi.resolve("context-toolbar"),
              toggleOnExecute: !1,
              aria: { mode: "none" },
            }),
            Da.config({ mode: "cyclic" }),
          ]),
          shell: !0,
        }),
      ),
    ...
    return {
      ...
      createGroups: function (n) {
        return ue(n, i(zp.sketch, e));
      },
      setGroups: function (n) {
        o.set(n), t();
      },
      setContextToolbar: function (n) {
        ki.on(r), jp.setGroups(r, n);
      },
  ...
  function Jp(n, e) {
    Er(n.element(), e.openClass),
      Or(n.element(), e.closedClass),
      Bi(n.element(), qp(e), "0px"),
      ai(n.element());
  }
  function Qp(n, e) {
    Er(n.element(), e.closedClass),
      Or(n.element(), e.openClass),
      ci(n.element(), qp(e));
  }
  function Zp(n, e, t, r) {
    t.setCollapsed(),
      Bi(n.element(), qp(e), Yp(e, n.element())),
      ai(n.element()),
      Kp(n, e),
      Jp(n, e),
      e.onStartShrink(n),
  ...
  function nh(n, e, t, r) {
    var o = r.getOrThunk(function () {
      return Yp(e, n.element());
    });
    t.setCollapsed(), Bi(n.element(), qp(e), o), ai(n.element());
    var i = Xp(n, e);
    Er(i, e.growingClass),
      Or(i, e.shrinkingClass),
      Jp(n, e),
      e.onStartShrink(n);
  }
  function eh(n, e, t) {
    var r = Yp(e, n.element());
  ...
  function th(n, e, t) {
    var r = Xp(n, e),
      ...
      i = Yp(e, n.element());
    Qp(n, e);
    var u = Yp(e, n.element());
    (o
      ? function () {
          Bi(n.element(), qp(e), i), ai(n.element());
        }
      : function () {
          Jp(n, e);
        })(),
      Er(r, e.shrinkingClass),
      Or(r, e.growingClass),
      Qp(n, e),
      Bi(n.element(), qp(e), u),
      t.setExpanded(),
  ...
  function rh(n, e, t) {
    var r = Xp(n, e);
    return !0 === Cr(r, e.growingClass);
  }
  function oh(n, e, t) {
    var r = Xp(n, e);
    return !0 === Cr(r, e.shrinkingClass);
  }
  function ih(e, t) {
    var r = Hm(
        fm.sketch({
    ...
    return {
      appear: function (n, e, t) {
        !0 === yh.hasShrunk(r) &&
          !1 === yh.isTransitioning(r) &&
          l.window.requestAnimationFrame(function () {
            e(t), eg.set(r, [n()]), yh.grow(r);
          });
      },
      disappear: o,
      component: b(r),
  ...
  function uh(n) {
    return (
      8 === n.raw().which &&
      !k(["input", "textarea"], Y(n.target())) &&
      !(function (n, e, t) {
        return $i(n, e, t).isSome();
      })(n.target(), '[contenteditable="true"]')
    );
  }
  function ch(e, n) {
    var t = Pt("Getting GUI events settings", xh, n),
      r = Fg(t),
      o = ue(
        [
          "touchstart",
      ...
      c = Kd(e, "keydown", function (n) {
        t.triggerEvent("keydown", n)
          ? n.kill()
          : !0 === t.stopBackspace && uh(n) && n.prevent();
      }),
      a = (function (n, e) {
        return bh ? Jd(n, "focus", e) : Kd(n, "focusin", e);
      })(e, function (n) {
        t.triggerEvent("focusin", n) && n.kill();
      }),
      f = An(On.none()),
      s = (function (n, e) {
        return bh ? Jd(n, "blur", e) : Kd(n, "focusout", e);
      })(e, function (n) {
  ...
  function fh(n, r, e, t, o, i) {
    ...
    return u.fold(
      function () {
        return i.logEventNoHandlers(r, t), wh.complete();
      },
      function (e) {
        var t = e.descHandler();
        return (
          bd(t)(c),
          c.isStopped()
            ? (i.logEventStopped(r, e.element(), t.purpose()), wh.stopped())
            : c.isCut()
              ? (i.logEventCut(r, e.element(), t.purpose()), wh.complete())
              : sn(e.element()).fold(
                  function () {
                    return (
                      i.logNoParent(r, e.element(), t.purpose()), wh.complete()
                    );
                  },
                  function (n) {
                    return (
  ...
  var lh,
    ...
    mh = function () {
      return Hm(
        fm.sketch({
          dom: Hs('<div class="${prefix}-editor-socket"></div>'),
          components: [],
          containerBehaviours: mo([eg.config({})]),
        }),
      );
    },
    gh = function (n, e, t, r) {
    ...
    ph = /* */ Object.freeze({
      ...
      shrink: function (n, e, t) {
        t.isExpanded() && eh(n, e, t);
      },
      immediateShrink: function (n, e, t) {
        t.isExpanded() && Zp(n, e, t, On.none());
      },
      ...
      isTransitioning: function (n, e, t) {
        return !0 === rh(n, e) || !0 === oh(n, e);
      },
      toggleGrow: function (n, e, t) {
        (t.isExpanded() ? eh : th)(n, e, t);
      },
      disableTransitions: Kp,
    }),
    hh = /* */ Object.freeze({
      __proto__: null,
      exhibit: function (n, e) {
    ...
    Sh = function (e, t, r, n, o, i) {
      return fh(e, t, r, n, o, i).fold(
        function () {
          return !0;
        },
        function (n) {
          return Sh(e, t, r, n, o, i);
        },
        function () {
          return !1;
        },
    ...
    Th = function (n, e, t, r, o) {
      var i = ah(t, r);
      return Sh(n, e, t, r, i, o);
    },
      ...
      var u = Ch(),
        n = ch(t.element(), {
          triggerEvent: function (e, t) {
            return Po(e, t.target(), function (n) {
              return (function (n, e, t, r) {
                var o = t.target();
                return Th(n, e, t, o, r);
              })(o, e, t, n);
                ...
                Po(_e(), e, function (n) {
                  return (
                    (function (n, e, t, r, o) {
                      ...
                      o,
                      _e(),
                      { originator: b(t), kill: w, prevent: w, target: b(e) },
                      e,
                      n,
                    ),
                    !1
        ...
        e = function (n) {
          n.connect(c),
            Ke(n.element()) ||
              (u.register(n),
              C(n.components(), e),
              c.triggerEvent(Ne(), n.element(), { target: b(n.element()) }));
        },
        a = function (n) {
          Ke(n.element()) || (C(n.components(), a), u.unregister(n)),
            n.disconnect();
        },
        f = function (n) {
          !(function (n, e) {
  ...
  function Ih(n) {
    var e = Hm(
      fm.sketch({
        ...
        containerBehaviours: mo([bo.config({ alpha: _h(), omega: Mh() })]),
      }),
    );
    return Dh(e);
  }
  var Ah = function (n, e) {
      var t = $e.fromTag("input");
      oi(t, {
        opacity: "0",
        position: "absolute",
        top: "-1000px",
    ...
    Bh = {
      stubborn: function (n, e, t, r) {
        ...
        var i = Kd(t, "keydown", function (n) {
          k(["input", "textarea"], Y(n.target())) || o();
        });
        return {
          toReading: function () {
            Ah(n, To);
    ...
    Vh = function (e, r, t, o, n) {
      ...
      var f = Rg(e),
        ...
        l = [
          ...
          Kd(e.doc(), "touchend", function (n) {
            an(e.html(), n.target()) || an(e.body(), n.target());
          }),
          Kd(t, "transitionend", function (n) {
          ...
          Kd(e.body(), "touchstart", function (n) {
            c(), e.onTouchContent(), f.fireTouchstart(n);
          }),
          f.onTouchmove(),
          f.onTouchend(),
          Kd(e.body(), "click", function (n) {
            n.kill();
          }),
          Kd(t, "touchmove", function () {
  ...
  (Nh = undefined),
    ...
    (Ph = undefined),
    (function (n) {
      "object" == typeof jh && void 0 !== Hh
        ? (Hh.exports = n())
        : "function" == typeof Nh && Nh.amd
          ? Nh([], n)
      ...
      return (function s(i, u, c) {
        ...
        for (var f = "function" == typeof Ph && Ph, n = 0; n < c.length; n++)
          a(c[n]);
        return a;
      })(
        {
  ...
  function Yh(n, e) {
    ...
    return lv.fixed(n, t, e);
  }
  function Kh(n, e) {
    return lv.scroller(n, e);
  }
  function Jh(n) {
    var e = qh(n);
    return ("true" === vr(n, gv) ? Kh : Yh)(n, e);
  }
  function Qh(n, e, t) {
    var r = fn(n).dom().defaultView.innerHeight;
    return pr(n, pv, r + "px"), r - e - t;
  }
  function Zh(n) {
  ...
  var tv = Lh.exports.boltExport,
    ...
    av = function () {
      ...
      return {
        animate: function (r, o, n, i, e, t) {
          ...
          Dg.clearInterval(f);
          function a(n) {
            Dg.clearInterval(f), u(n);
          }
          f = Dg.setInterval(function () {
            var t = r();
            Uh(t, o, n).fold(
              function () {
                Dg.clearInterval(f), u(o);
              },
              function (n) {
                if ((i(n, a), !c)) {
                  var e = r();
      ...
      function e() {
        if (d) {
          var n = ji(i),
            e = ji(u),
            t = Qh(r, n, e);
          pr(r, dv, n + "px"), Bi(r, "height", t + "px"), sv(o, r, u);
        }
      }
      var t = fn(r).dom().defaultView,
        c = (function (n) {
          var e = vr(n, "style");
          oi(n, { position: "absolute", top: "0px" }),
            pr(n, dv, "0px"),
            pr(n, mv, "top");
          return {
            restore: function () {
              pr(n, "style", e || ""), br(n, dv), br(n, mv);
            },
          };
        })(i),
        a = ji(i),
        ...
        l = (function (n) {
          var e = vr(n, "style");
          oi(n, { position: "absolute", bottom: "0px" }),
            pr(n, dv, "0px"),
            pr(n, mv, "bottom");
          return {
            restore: function () {
    ...
    wv = function (t, r, o) {
      return uv(function (n) {
        ...
        bv.animate(
          ...
          15,
          function (n) {
            (t.dom().scrollTop = n), Bi(t, "top", Zh(t) + 15 + "px");
          },
          function () {
            (t.dom().scrollTop = r), Bi(t, "top", o + "px"), n(r);
          },
          10,
        );
      });
    ...
    Sv = function (o, i) {
      return uv(function (n) {
        ...
        bv.animate(
          ...
          r,
          function (n, e) {
            Ng(o, xv) !== o.dom().scrollTop
              ? e(o.dom().scrollTop)
              : ((o.dom().scrollTop = n), pr(o, xv, n));
          },
          function () {
            (o.dom().scrollTop = i), pr(o, xv, i), n(i);
          },
          10,
        );
      });
    ...
    Ov = function (e, t, r) {
      var o = fn(e).dom().defaultView;
      return uv(function (n) {
        ev(e, r), ev(t, r), o.scrollTo(0, r), n(r);
      });
    };
  function kv(i, n) {
    return n(function (t) {
  ...
  function Cv(e, t, n, r, o, i) {
    var u = (function f(t) {
      ...
      c = sp(function () {
        u.idle(function () {
          _v(n, r.pageYOffset).get(function () {
            (function () {
              var n = xp(i);
              return On.from(n[0]).bind(function (n) {
                var e = n.top() - t.dom().scrollTop;
                return e > r.innerHeight + 5 || e < -5
                  ? On.some({ top: b(e), bottom: b(e + n.height()) })
                  : On.none();
              });
            })().each(function (n) {
      ...
      a = Kd($e.fromDom(r), "scroll", function () {
        r.pageYOffset < 0 || c.throttle();
      });
    return _v(n, r.pageYOffset).get(y), { unbind: a.unbind };
  }
  var Dv = function (n, e, t, r, o) {
      var i = fv(e, t),
        u = d(Fh, n);
      i < r || i < o
        ? Sv(e, e.dom().scrollTop - i + o).get(u)
        : r < 0 && Sv(e, e.dom().scrollTop + r).get(u);
    },
    _v = function (n, e) {
      var t = hv(n);
      return (function (n) {
    ...
    Mv = function (n) {
      ...
      var m = Kd($e.fromDom(a), "resize", function () {
        ...
        p = (function v(t, e) {
          ...
          Or(r, Mi.resolve("unfocused-selections")),
            rt($e.fromDom(n.documentElement), r);
          var i = Kd(r, "touchstart", function (n) {
              n.prevent(), Rh(t, e), u();
            }),
            u = function () {
              hn(r);
      ...
      return {
        ...
        setViewportOffset: function (n) {
          s.setViewportOffset(n), Tv(r, n).get(y);
        },
        syncHeight: function () {
          Bi(
            u,
    ...
    Iv = function (r, n) {
      ...
      return {
        enter: function () {
          n.hide();
          var t = $e.fromDom(l.document);
          Op.getActiveApi(r.editor).each(function (n) {
            i.set({
              socketHeight: ui(r.socket, "height"),
              iframeHeight: ui(n.frame(), "height"),
              outerScroll: l.document.body.scrollTop,
            }),
              u.set({ exclusives: Gp.exclusive(t, "." + gg.scrollable()) }),
              Or(r.container, Mi.resolve("fullscreen-maximized")),
              _p(r.container, n.body()),
              o.maximize(),
              Bi(r.socket, "overflow", "scroll"),
              Bi(r.socket, "-webkit-overflow-scrolling", "touch"),
              So(n.body());
            var e = en(
              [
                "cWin",
            ...
            c.set(
              ...
              a.set(Vh(n, c, r.toolstrip, r.socket, r.dropup));
          });
        },
          ...
          o.restore(),
            ...
            i.on(function (n) {
              n.socketHeight.each(function (n) {
                Bi(r.socket, "height", n);
              }),
                n.iframeHeight.each(function (n) {
                  Bi(r.editor.getFrame(), "height", n);
                }),
            ...
            u.clear(),
            Er(r.container, Mi.resolve("fullscreen-maximized")),
            Mp(),
            gg.deregister(r.toolbar),
            ci(r.socket, "overflow"),
            ci(r.socket, "-webkit-overflow-scrolling"),
            To(r.editor.getFrame()),
            Op.getActiveApi(r.editor).each(function (n) {
              n.clearSelection();
            });
        },
    ...
    Av = function (n) {
      var e = Pt("Getting IosWebapp schema", Rp, n);
      Bi(e.toolstrip, "width", "100%"), Bi(e.container, "position", "relative");
      var t = Hm(
        Fp(function () {
          e.setReadOnly(e.readOnlyOnInit()), o.enter();
        }, e.translate),
  ...
  function Fv(n, e, t) {
    n.system().broadcastOn([Vo.formatChanged()], { command: e, state: t });
  }
  function Rv(m) {
    return {
      ...
      renderUI: function () {
        ...
        (function (n) {
          ...
          ? (m.contentCSS.push(e.content),
            Fo.DOM.styleSheetLoader.load(e.ui, jv(m)))
          : jv(m)();
        function t() {
          m.fire("ScrollIntoView");
        }
        var f = G().os.isAndroid()
          ? (function c(n) {
              var e = Ih({ classes: [Mi.resolve("android-container")] }),
                t = Up(),
                r = md(),
                o = dh(r),
                i = mh(),
          ...
          : (function a(n) {
              var e = Ih({ classes: [Mi.resolve("ios-container")] }),
                t = Up(),
                r = md(),
                o = dh(r),
                i = mh(),
        ...
        var r = n.ownerDocument.defaultView,
          d = Mg(r, {
            onChange: function () {
              f.system().broadcastOn([Vo.orientationChanged()], {
                width: Ig(r),
              });
            },
            onReady: w,
          ...
          m.on("init", function () {
            f.init({
              editor: {
                ...
                onTapContent: function (n) {
                  var e = n.target();
                  if ("img" === Y(e)) m.selection.select(e.dom()), n.kill();
                  else if ("a" === Y(e)) {
                    f.system()
                      .getByDom($e.fromDom(m.editorContainer))
                      .each(function (n) {
                        bo.isAlpha(n) && Bo(e.dom());
                      });
                  }
                },
              },
              container: $e.fromDom(m.editorContainer),
              socket: $e.fromDom(m.contentAreaContainer),
              toolstrip: $e.fromDom(
                m.editorContainer.querySelector("." + Mi.resolve("toolstrip")),
              ),
              toolbar: $e.fromDom(
                m.editorContainer.querySelector("." + Mi.resolve("toolbar")),
              ),
              dropup: f.dropup(),
              alloy: f.system(),
              translate: w,
            ...
            var n = function () {
                f.dropup().disappear(function () {
                  f.system().broadcastOn([Vo.dropupDismissed()], {});
                });
              },
              e = {
  ...
  var Bv = tinymce.util.Tools.resolve("tinymce.EditorManager"),
    Vv = function (n) {
      var e = Mn(n.settings, "skin_url").fold(
        function () {
          return Bv.baseURL + "/skins/ui/oxide";
        },
        function (n) {
          return n;
        },
