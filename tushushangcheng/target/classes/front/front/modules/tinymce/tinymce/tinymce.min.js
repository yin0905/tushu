...
!(function (j) {
  ...
  function Pr(i) {
    ...
    i.valid_elements
      ...
      : (Mr(r, function (e, t) {
        ...
        Mr(
          Or("p h1 h2 h3 h4 h5 h6 th td pre div address caption li"),
          function (e) {
            z[e].paddEmpty = !0;
          },
        ),
    ...
    return (
      ...
      ei(function (e, t, n, r) {
        ...
        if (e) {
          ...
          (d = li(d === t ? d.splice(s, d.length) : d)),
            y ? y(null, t, d, r) : Ro.apply(t, d);
      })
    );
  }
  function di(e) {
  ...
  (ai.prototype = to.filters = to.pseudos),
    ...
    (ao = Jo.select =
      function (e, t, n, r) {
        ...
        return (
          (s || io(e, l))(r, t, !mo, n, (Yo.test(e) && ii(t.parentNode)) || t),
          n
        );
      }),
    (eo.sortStable = yo.split("").sort(No).join("") === yo),
      ...
      F = {
        ...
        getOuterHTML: function (e) {
          ...
          return Qt.isElement(t)
            ? t.outerHTML
            : Ii("<div></div>").append(Ii(t).clone()).html();
        },
    ...
    Pm = function (e, t, n) {
      if (
        ...
        !(function (r, e) {
          ...
          var o = t.bind(Ce).filter(Lt).bind(rm),
            i = n.bind(we).filter(Lt).bind(rm);
  ...
  function Tv(n, e, r, t, o, i) {
    return tu(
      ly.findRootInline(e, r, t),
      ly.findRootInline(e, r, o),
      function (e, t) {
  ...
  function _b(t, n, e) {
    ...
    return tu(r, o, Mb).filter(function (e) {
      return (
        ...
        (function (e) {
          return (
            !1 === Qt.isContentEditableFalse(e.from().block().dom()) &&
            !1 === Qt.isContentEditableFalse(e.to().block().dom())
          );
        })(e)
      );
    });
  ...
  function tC(e, t, n, r) {
    ...
    e.undoManager.ignore(function () {
      e.selection.setRng(
        ...
        my(i, o, Vc.fromRangeStart(e.selection.getRng())).map(vy).map(eC(e, t));
    }),
      e.nodeChanged();
  }
  function nC(n, r, o, i) {
  ...
  var Mw = d(tb, Wu.isAbove, -1),
    ...
    Hx = function (t) {
      t.on("keydown", function (e) {
        !1 === e.isDefaultPrevented() &&
          (function (e, t) {
            Fw([{ keyCode: hh.SPACEBAR, action: Iw(Sw, e) }], t).each(
              function (e) {
                t.preventDefault();
              },
            );
        ...
        (r = ka(it.fromDom(g.getBody()), "#" + b).fold(
          ...
          l === f && Wn.ie
            ? (r
              ...
              e.setEndAfter(l))
            : (r.empty().append(qr).append(l).append(qr),
  ...
  var pE,
    ...
    SE =
      ...
      (kE.prototype.createShortcut = function (e, t, n, r) {
        var o;
        return (
          ((o = Zn.map(zE(e, ">"), this.parseShortcut))[o.length - 1] =
